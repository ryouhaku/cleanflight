...
# 342 "./src/main/telemetry/frsky.c"
static void sendVario(void)
{
    sendDataHead(0x30);
    serialize16(getEstimatedVario());
}
# 355 "./src/main/telemetry/frsky.c"
...
# 373 "./src/main/telemetry/frsky.c"
...
# 473 "./src/main/telemetry/frsky.c" 3 4
                             ((void *)0)
# 473 "./src/main/telemetry/frsky.c"
                                 ;
    frSkyTelemetryWrite = 
# 474 "./src/main/telemetry/frsky.c" 3 4
                         ((void *)0)
# 474 "./src/main/telemetry/frsky.c"
                             ;
}
...
void freeFrSkyTelemetryPort(void)
{
    if (frskyPort) {
        ...
        frskyPort = 
# 481 "./src/main/telemetry/frsky.c" 3 4
                   ((void *)0)
# 481 "./src/main/telemetry/frsky.c"
                       ;
        frSkyTelemetryWrite = 
...
# 489 "./src/main/telemetry/frsky.c" 3 4
                                                                                    ((void *)0)
# 489 "./src/main/telemetry/frsky.c"
...
# 529 "./src/main/telemetry/frsky.c" 3 4
                              ((void *)0)
# 529 "./src/main/telemetry/frsky.c"
                                  ) {
        return;
    }

    if (currentTimeUs < frskyLastCycleTime + 125000) {
        return;
    }
...
# 604 "./src/main/telemetry/frsky.c"
        if (sensors(SENSOR_MAG)) {
