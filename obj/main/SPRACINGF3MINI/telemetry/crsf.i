...
# 32 "./src/main/telemetry/crsf.h" 3 4
_Bool 
...
static 
# 72 "./src/main/telemetry/crsf.c" 3 4
      _Bool 
# 72 "./src/main/telemetry/crsf.c"
...
# 88 "./src/main/telemetry/crsf.c" 3 4
_Bool 
# 88 "./src/main/telemetry/crsf.c"
    bufferCrsfMspFrame(uint8_t *frameStart, int frameLength)
{
    if (mspRxBuffer.len + 1 + frameLength > 96) {
        return 
# 91 "./src/main/telemetry/crsf.c" 3 4
              0
# 91 "./src/main/telemetry/crsf.c"
                   ;
    } else {
...
# 105 "./src/main/telemetry/crsf.c"
    ...
    int pos = 0;
    while (
# 108 "./src/main/telemetry/crsf.c" 3 4
          1
# 108 "./src/main/telemetry/crsf.c"
              ) {
...
# 291 "./src/main/telemetry/crsf.c"
void crsfFrameDeviceInfo(sbuf_t *dst) {

    char buff[30];
    tfp_sprintf(buff, "%s %s: %s", "Cleanflight", "2" "." "2" "." "0", systemConfig()->boardIdentifier);
...
static 
# 327 "./src/main/telemetry/crsf.c" 3 4
      _Bool 
# 327 "./src/main/telemetry/crsf.c"
           mspReplyPending;

void crsfScheduleMspResponse(void)
{
    mspReplyPending = 
# 331 "./src/main/telemetry/crsf.c" 3 4
                     1
# 331 "./src/main/telemetry/crsf.c"
                         ;
}
...
{
    deviceInfoReplyPending = 
# 385 "./src/main/telemetry/crsf.c" 3 4
                            1
# 385 "./src/main/telemetry/crsf.c"
                                ;
}
...
void initCrsfTelemetry(void)
{
    ...
    deviceInfoReplyPending = 
# 394 "./src/main/telemetry/crsf.c" 3 4
                            0
# 394 "./src/main/telemetry/crsf.c"
                                 ;

    mspReplyPending = 
# 396 "./src/main/telemetry/crsf.c" 3 4
                     0
# 396 "./src/main/telemetry/crsf.c"
                          ;
...
# 414 "./src/main/telemetry/crsf.c" 3 4
_Bool 
# 414 "./src/main/telemetry/crsf.c"
    checkCrsfTelemetryState(void)
{
...
void handleCrsfTelemetry(timeUs_t currentTimeUs)
{
    ...
    if (deviceInfoReplyPending) {
        ...
        crsfFinalize(dst);
        deviceInfoReplyPending = 
# 449 "./src/main/telemetry/crsf.c" 3 4
                                0
# 449 "./src/main/telemetry/crsf.c"
                                     ;
        crsfLastCycleTime = currentTimeUs;
        return;
    }
