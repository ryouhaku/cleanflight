...
# 72 "./src/main/telemetry/ibus_shared.c" 3 4
                                     ((void *)0)
# 72 "./src/main/telemetry/ibus_shared.c"
                                         ;
...
static 
# 112 "./src/main/telemetry/ibus_shared.c" 3 4
      _Bool 
# 112 "./src/main/telemetry/ibus_shared.c"
...
static uint8_t dispatchMeasurementReply(ibusAddress_t address)
{
    ...
    case IBUS_SENSOR_TYPE_TEMPERATURE:
        ...
        return sendIbusMeasurement(address, value + (400));
...
static 
# 152 "./src/main/telemetry/ibus_shared.c" 3 4
      _Bool 
# 152 "./src/main/telemetry/ibus_shared.c"
...
# 196 "./src/main/telemetry/ibus_shared.c" 3 4
_Bool 
# 196 "./src/main/telemetry/ibus_shared.c"
    isChecksumOkIa6b(const uint8_t *ibusPacket, const uint8_t length)
{
