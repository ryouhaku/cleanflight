...
# 65 "./src/main/telemetry/msp_shared.c" 3 4
                                          ((void *)0)
# 65 "./src/main/telemetry/msp_shared.c"
                                              ;
    ...
    if (mspPostProcessFn) {
        mspPostProcessFn(
# 70 "./src/main/telemetry/msp_shared.c" 3 4
                        ((void *)0)
# 70 "./src/main/telemetry/msp_shared.c"
                            );
    }
...
# 87 "./src/main/telemetry/msp_shared.c" 3 4
_Bool 
# 87 "./src/main/telemetry/msp_shared.c"
    handleMspFrame(uint8_t *frameStart, int frameLength)
{
    ...
    if (version != 1) {
        ...
        return 
# 109 "./src/main/telemetry/msp_shared.c" 3 4
              1
# 109 "./src/main/telemetry/msp_shared.c"
                  ;
    }
...
# 129 "./src/main/telemetry/msp_shared.c"
    ...
    if (bufferBytesRemaining >= frameBytesRemaining) {
        ...
        lastSeq = seqNumber;
        return 
# 141 "./src/main/telemetry/msp_shared.c" 3 4
              0
# 141 "./src/main/telemetry/msp_shared.c"
                   ;
    } else {
        ...
        if (checksum != *frameBuf->ptr) {
            ...
            return 
# 154 "./src/main/telemetry/msp_shared.c" 3 4
                  1
# 154 "./src/main/telemetry/msp_shared.c"
                      ;
        }
    }
    ...
    sendMspReply(uint8_t payloadSize, mspResponseFnPtr responseFn)
{
    ...
    if (bufferBytesRemaining >= payloadBytesRemaining) {
        ...
        return 
# 202 "./src/main/telemetry/msp_shared.c" 3 4
              1
# 202 "./src/main/telemetry/msp_shared.c"
                  ;
    ...
    responseFn(payloadOut);
    return 
# 225 "./src/main/telemetry/msp_shared.c" 3 4
          0
# 225 "./src/main/telemetry/msp_shared.c"
               ;
}
