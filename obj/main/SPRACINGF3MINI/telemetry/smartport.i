...
# 94 "./src/main/rx/crsf.h" 3 4
_Bool 
# 94 "./src/main/rx/crsf.h"
    crsfRxIsActive(void);
...
# 145 "./src/main/telemetry/smartport.c" 3 4
                                          ((void *)0)
# 145 "./src/main/telemetry/smartport.c"
                                              ;
static serialPortConfig_t *portConfig;

static 
# 148 "./src/main/telemetry/smartport.c" 3 4
      _Bool 
# 148 "./src/main/telemetry/smartport.c"
...
# 211 "./src/main/telemetry/smartport.c"
        ...
        if (byteStuffing) {
            c ^= FSSP_DLE_XOR;
            byteStuffing = 
# 217 "./src/main/telemetry/smartport.c" 3 4
                          0
# 217 "./src/main/telemetry/smartport.c"
                               ;
        }

        rxBuffer[smartPortRxBytes++] = c;

        if (smartPortRxBytes == sizeof(smartPortFrame_t)) {
            if (c == (0xFF - checksum)) {
                smartPortFrameReceived = 
...
# 226 "./src/main/telemetry/smartport.c"
                                ;
        } else if (smartPortRxBytes < sizeof(smartPortFrame_t)) {
            checksum += c;
            checksum += checksum >> 8;
            checksum &= 0x00FF;
        }
...
static void smartPortSendByte(uint8_t c, uint16_t *crcp)
{
    ...
    if (crcp == 
# 246 "./src/main/telemetry/smartport.c" 3 4
               ((void *)0)
# 246 "./src/main/telemetry/smartport.c"
                   )
        return;
...
static void smartPortSendPackageEx(uint8_t frameId, uint8_t* data)
{
    ...
    for (unsigned i = 0; i < (sizeof(smartPortFrame_t) - 
...
# 260 "./src/main/telemetry/smartport.c"
    ...
    smartPortSendByte(0xFF - (uint8_t)crc, 
# 263 "./src/main/telemetry/smartport.c" 3 4
                                          ((void *)0)
# 263 "./src/main/telemetry/smartport.c"
                                              );
}

static void smartPortSendPackage(uint16_t id, uint32_t val)
{
    uint8_t payload[(sizeof(smartPortFrame_t) - 
# 268 "./src/main/telemetry/smartport.c" 3 4
                   __builtin_offsetof (
# 268 "./src/main/telemetry/smartport.c"
                   smartPortFrame_t
# 268 "./src/main/telemetry/smartport.c" 3 4
                   , 
# 268 "./src/main/telemetry/smartport.c"
...
# 303 "./src/main/telemetry/smartport.c" 3 4
                                                                                              ((void *)0)
# 303 "./src/main/telemetry/smartport.c"
    ...
    smartPortTelemetryEnabled = 
# 310 "./src/main/telemetry/smartport.c" 3 4
                               1
# 310 "./src/main/telemetry/smartport.c"
                                   ;
    smartPortLastRequestTime = millis();
}


# 314 "./src/main/telemetry/smartport.c" 3 4
_Bool 
# 314 "./src/main/telemetry/smartport.c"
    canSendSmartPortTelemetry(void)
{
...
# 321 "./src/main/telemetry/smartport.c" 3 4
   _Bool 
# 321 "./src/main/telemetry/smartport.c"
        newTelemetryEnabledValue = telemetryDetermineEnabledState(smartPortPortSharing);
...
void handleSmartPortTelemetry(void)
{
    ...
    if (smartPortFrameReceived) {
        smartPortFrameReceived = 
# 356 "./src/main/telemetry/smartport.c" 3 4
                                0
# 356 "./src/main/telemetry/smartport.c"
                                     ;
        ...
        if (smartPortRxBuffer.frameId == FSSP_MSPC_FRAME) {
            ...
            uint8_t *frameStart = (uint8_t *)&smartPortRxBuffer + 
# 363 "./src/main/telemetry/smartport.c" 3 4
                                                                 __builtin_offsetof (
# 363 "./src/main/telemetry/smartport.c"
                                                                 smartPortFrame_t
# 363 "./src/main/telemetry/smartport.c" 3 4
                                                                 , 
# 363 "./src/main/telemetry/smartport.c"
...
# 363 "./src/main/telemetry/smartport.c"
                                                                                         ;
            smartPortMspReplyPending = handleMspFrame(frameStart, (sizeof(smartPortFrame_t) - 
# 364 "./src/main/telemetry/smartport.c" 3 4
                                                                 __builtin_offsetof (
# 364 "./src/main/telemetry/smartport.c"
                                                                 smartPortFrame_t
# 364 "./src/main/telemetry/smartport.c" 3 4
                                                                 , 
# 364 "./src/main/telemetry/smartport.c"
...
# 364 "./src/main/telemetry/smartport.c"
    ...
    while (smartPortHasRequest) {
        ...
        if (smartPortMspReplyPending) {
            smartPortMspReplyPending = sendMspReply((sizeof(smartPortFrame_t) - 
...
# 465 "./src/main/telemetry/smartport.c"
            ...
            case FSSP_DATAID_ACCX :
                smartPortSendPackage(id, 100 * acc.accSmooth[X] / acc.dev.acc_1G);
                smartPortHasRequest = 0;
                break;
            ...
            case FSSP_DATAID_T2 :
                ...
                break;
# 583 "./src/main/telemetry/smartport.c"
            case FSSP_DATAID_A4 :
                if (batteryConfig()->voltageMeterSource != VOLTAGE_METER_NONE && getBatteryCellCount() > 0) {
