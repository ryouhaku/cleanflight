...
void transponderIrInitArcitimer(transponder_t *transponder){
    ...
    memset(&(transponder->transponderIrDMABuffer.arcitimer), 0, 155 * 4);
}
...
# 49 "./src/main/drivers/transponder_ir_arcitimer.c" 3 4
           _Bool 
# 49 "./src/main/drivers/transponder_ir_arcitimer.c"
