...
# 136 "./src/main/drivers/compass/compass_hmc5883l.c"
static void hmc5883_extiHandler(extiCallbackRec_t* cb)
{
    (void)(cb);
# 153 "./src/main/drivers/compass/compass_hmc5883l.c"
}
...
# 178 "./src/main/drivers/compass/compass_hmc5883l.c"
    ...
    IOConfigGPIO(magIntIO, ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
    EXTIHandlerInit(&mag->exti, hmc5883_extiHandler);
    EXTIConfig(magIntIO, &mag->exti, (((((0x0f)<<(4-(7-(((uint32_t)0x500)>>8))))|((0x0f)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0), EXTI_Trigger_Rising);
    EXTIEnable(magIntIO, 
# 182 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
                        1
# 182 "./src/main/drivers/compass/compass_hmc5883l.c"
                            );
