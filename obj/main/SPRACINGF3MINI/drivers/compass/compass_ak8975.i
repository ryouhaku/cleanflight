...
# 6 "/home/nirigan3/icarus/cleanflight/tools/gcc-arm-none-eabi-6-2017-q2-update/arm-none-eabi/include/math.h" 2 3
...
# 7 "/home/nirigan3/icarus/cleanflight/tools/gcc-arm-none-eabi-6-2017-q2-update/arm-none-eabi/include/math.h" 2 3
# 1 "/home/nirigan3/icarus/cleanflight/tools/gcc-arm-none-eabi-6-2017-q2-update/arm-none-eabi/include/machine/ieeefp.h" 1 3
# 8 "/home/nirigan3/icarus/cleanflight/tools/gcc-arm-none-eabi-6-2017-q2-update/arm-none-eabi/include/math.h" 2 3
# 1 "/home/nirigan3/icarus/cleanflight/tools/gcc-arm-none-eabi-6-2017-q2-update/arm-none-eabi/include/_ansi.h" 1 3
# 9 "/home/nirigan3/icarus/cleanflight/tools/gcc-arm-none-eabi-6-2017-q2-update/arm-none-eabi/include/math.h" 2 3
...
# 29 "./src/main/drivers/compass/compass_ak8975.c" 2
...
# 36 "./src/main/drivers/compass/compass_ak8975.c" 2
...
# 39 "./src/main/drivers/compass/compass_ak8975.c" 2
# 77 "./src/main/drivers/compass/compass_ak8975.c"
static 
# 77 "./src/main/drivers/compass/compass_ak8975.c" 3 4
      _Bool 
# 77 "./src/main/drivers/compass/compass_ak8975.c"
           ak8975Init(magDev_t *mag)
{
    ...
    busWriteRegister(busdev, 0x0A, 0x00);
    delay(20);

    busWriteRegister(busdev, 0x0A, 0x0F);
    delay(10);

    busReadRegisterBuffer(busdev, 0x10, asa, sizeof(asa));
    delay(10);
    ...
    busReadRegisterBuffer(busdev, 0x02, &status, 1);
    busReadRegisterBuffer(busdev, 0x09, &status, 1);


    busWriteRegister(busdev, 0x0A, 0x10 | 0x01);
    return 
# 106 "./src/main/drivers/compass/compass_ak8975.c" 3 4
          1
# 106 "./src/main/drivers/compass/compass_ak8975.c"
              ;
}
...
# 111 "./src/main/drivers/compass/compass_ak8975.c" 3 4
                       (-0x7fff - 1)
# 111 "./src/main/drivers/compass/compass_ak8975.c"
                                , 
# 111 "./src/main/drivers/compass/compass_ak8975.c" 3 4
                                  (0x7fff)
# 111 "./src/main/drivers/compass/compass_ak8975.c"
...
static 
# 114 "./src/main/drivers/compass/compass_ak8975.c" 3 4
      _Bool 
# 114 "./src/main/drivers/compass/compass_ak8975.c"
           ak8975Read(magDev_t *mag, int16_t *magData)
{
    
# 116 "./src/main/drivers/compass/compass_ak8975.c" 3 4
   _Bool 
# 116 "./src/main/drivers/compass/compass_ak8975.c"
        ack;
    uint8_t status;
    uint8_t buf[6];
    ...
    ack = busReadRegisterBuffer(busdev, 0x02, &status, 1);
    if (!ack || (status & 0x01) == 0) {
        return 
# 124 "./src/main/drivers/compass/compass_ak8975.c" 3 4
              0
# 124 "./src/main/drivers/compass/compass_ak8975.c"
                   ;
    }

    busReadRegisterBuffer(busdev, 0x03, buf, 6);

    ack = busReadRegisterBuffer(busdev, 0x09, &status, 1);
    if (!ack) {
        return 
# 131 "./src/main/drivers/compass/compass_ak8975.c" 3 4
              0
# 131 "./src/main/drivers/compass/compass_ak8975.c"
                   ;
    }
    ...
    if (status & 0x04) {
        return 
# 137 "./src/main/drivers/compass/compass_ak8975.c" 3 4
              0
# 137 "./src/main/drivers/compass/compass_ak8975.c"
                   ;
    }

    if (status & 0x08) {
        return 
# 141 "./src/main/drivers/compass/compass_ak8975.c" 3 4
              0
# 141 "./src/main/drivers/compass/compass_ak8975.c"
                   ;
    }
...
# 151 "./src/main/drivers/compass/compass_ak8975.c" 3 4
_Bool 
# 151 "./src/main/drivers/compass/compass_ak8975.c"
    ak8975Detect(magDev_t *mag)
{
    uint8_t sig = 0;
    ...
    if (busdev->bustype == BUSTYPE_I2C && busdev->busdev_u.i2c.address == 0) {
        busdev->busdev_u.i2c.address = 0x0C;
    }

    
# 161 "./src/main/drivers/compass/compass_ak8975.c" 3 4
   _Bool 
# 161 "./src/main/drivers/compass/compass_ak8975.c"
        ack = busReadRegisterBuffer(busdev, 0x00, &sig, 1);

    if (!ack || sig != 0x48)
        return 
# 164 "./src/main/drivers/compass/compass_ak8975.c" 3 4
              0
# 164 "./src/main/drivers/compass/compass_ak8975.c"
                   ;
    ...
    return 
# 169 "./src/main/drivers/compass/compass_ak8975.c" 3 4
          1
# 169 "./src/main/drivers/compass/compass_ak8975.c"
              ;
}
