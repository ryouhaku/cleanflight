...
# 43 "./src/main/drivers/transponder_ir.c" 3 4
                                    ((void *)0)
# 43 "./src/main/drivers/transponder_ir.c"
                                        ;
...
# 75 "./src/main/drivers/transponder_ir.c"
    ...
    IOConfigGPIOAF(transponderIO, ((GPIO_Mode_AF) | ((GPIO_Speed_Level_3) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_DOWN) << 5)), timerHardware->alternateFunction);
