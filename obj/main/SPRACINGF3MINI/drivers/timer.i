...
void timerChOvrHandlerInit(timerOvrHandlerRec_t *self, timerOvrHandlerCallback *fn)
{
    self->fn = fn;
    self->next = 
# 322 "./src/main/drivers/timer.c" 3 4
                ((void *)0)
# 322 "./src/main/drivers/timer.c"
                    ;
}
...
static void timerChConfig_UpdateOverflow(timerConfig_t *cfg, TIM_TypeDef *tim) {
    ...
    for ( uint8_t __basepri_save __attribute__ ((__cleanup__ (__basepriRestoreMem), __unused__)) = __get_BASEPRI(), __ToDo = __basepriSetMemRetVal((((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0)); __ToDo ; __ToDo = 0 ) {
        ...
        *chain = 
# 335 "./src/main/drivers/timer.c" 3 4
                ((void *)0)
# 335 "./src/main/drivers/timer.c"
                    ;
    }
...
void timerChConfigCallbacks(const timerHardware_t *timHw, timerCCHandlerRec_t *edgeCallback, timerOvrHandlerRec_t *overflowCallback)
{
    ...
    if (edgeCallback == 
# 349 "./src/main/drivers/timer.c" 3 4
                       ((void *)0)
# 349 "./src/main/drivers/timer.c"
                           )
...
void timerChConfigCallbacksDual(const timerHardware_t *timHw, timerCCHandlerRec_t *edgeCallbackLo, timerCCHandlerRec_t *edgeCallbackHi, timerOvrHandlerRec_t *overflowCallback)
{
    ...
    if (edgeCallbackLo == 
# 374 "./src/main/drivers/timer.c" 3 4
                         ((void *)0)
# 374 "./src/main/drivers/timer.c"
                             )
        TIM_ITConfig(timHw->tim, (((uint16_t)0x0002) << ((chLo) / 4)), DISABLE);
    if (edgeCallbackHi == 
# 376 "./src/main/drivers/timer.c" 3 4
                         ((void *)0)
# 376 "./src/main/drivers/timer.c"
                             )
...
# 383 "./src/main/drivers/timer.c" 3 4
                                                                ((void *)0)
# 383 "./src/main/drivers/timer.c"
                                                                    ;
...
void timerChConfigIC(const timerHardware_t *timHw, 
# 443 "./src/main/drivers/timer.c" 3 4
                                                  _Bool 
# 443 "./src/main/drivers/timer.c"
...
void timerChConfigICDual(const timerHardware_t *timHw, 
# 459 "./src/main/drivers/timer.c" 3 4
                                                      _Bool 
# 459 "./src/main/drivers/timer.c"
                                                           polarityRising, unsigned inputFilterTicks)
{
    TIM_ICInitTypeDef TIM_ICInitStructure;
...
void timerChICPolarity(const timerHardware_t *timHw, 
# 479 "./src/main/drivers/timer.c" 3 4
                                                    _Bool 
# 479 "./src/main/drivers/timer.c"
                                                         polarityRising)
{
...
void timerChConfigOC(const timerHardware_t* timHw, 
# 502 "./src/main/drivers/timer.c" 3 4
                                                  _Bool 
# 502 "./src/main/drivers/timer.c"
                                                       outEnable, 
# 502 "./src/main/drivers/timer.c" 3 4
                                                                  _Bool 
# 502 "./src/main/drivers/timer.c"
...
# 609 "./src/main/drivers/timer.c"
}
# 626 "./src/main/drivers/timer.c"
...
const timerHardware_t *timerGetByTag(ioTag_t tag, timerUsageFlag_e flag)
{
    if (!tag) {
        return 
# 781 "./src/main/drivers/timer.c" 3 4
              ((void *)0)
# 781 "./src/main/drivers/timer.c"
                  ;
    }
    ...
    return 
# 791 "./src/main/drivers/timer.c" 3 4
          ((void *)0)
# 791 "./src/main/drivers/timer.c"
              ;
}
