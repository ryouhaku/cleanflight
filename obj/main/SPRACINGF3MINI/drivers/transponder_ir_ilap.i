...
void transponderIrInitIlap(transponder_t *transponder){
    ...
    memset(&(transponder->transponderIrDMABuffer.ilap), 0, ((11 + 1) * 10 * 6));
...
# 50 "./src/main/drivers/transponder_ir_ilap.c" 3 4
               _Bool 
# 50 "./src/main/drivers/transponder_ir_ilap.c"
                    doToggles = 
# 50 "./src/main/drivers/transponder_ir_ilap.c" 3 4
                                0
# 50 "./src/main/drivers/transponder_ir_ilap.c"
                ...
                if (bitIndex == 0) {
                    doToggles = 
# 52 "./src/main/drivers/transponder_ir_ilap.c" 3 4
                               1
# 52 "./src/main/drivers/transponder_ir_ilap.c"
                                   ;
                }
