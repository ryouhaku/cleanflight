...
void buttonsInit(void)
{
    ...
    buttonAPin = IOGetByTag(((ioTag_t)((((1) + 1) << 4) | (1))));
    IOInit(buttonAPin, OWNER_SYSTEM, 0);
    IOConfigGPIO(buttonAPin, ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_UP) << 5)));



    buttonBPin = IOGetByTag(((ioTag_t)((((1) + 1) << 4) | (0))));
    IOInit(buttonBPin, OWNER_SYSTEM, 0);
    IOConfigGPIO(buttonBPin, ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_UP) << 5)));

}



# 54 "./src/main/drivers/buttons.c" 3 4
_Bool 
# 54 "./src/main/drivers/buttons.c"
    buttonAPressed(void)
{
...
# 61 "./src/main/drivers/buttons.c" 3 4
_Bool 
# 61 "./src/main/drivers/buttons.c"
    buttonBPressed(void)
{
