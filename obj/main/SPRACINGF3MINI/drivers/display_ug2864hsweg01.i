...
# 42 "./src/main/drivers/display_ug2864hsweg01.c"
           ...
           i2c_OLED_send_cmdarray(busDevice_t *bus, const uint8_t *commands, size_t len)
{
    for (size_t i = 0 ; i < len ; i++) {
        if (!i2c_OLED_send_cmd(bus, commands[i])) {
            return 
# 190 "./src/main/drivers/display_ug2864hsweg01.c" 3 4
                  0
# 190 "./src/main/drivers/display_ug2864hsweg01.c"
                       ;
        }
    }

    return 
# 194 "./src/main/drivers/display_ug2864hsweg01.c" 3 4
          1
# 194 "./src/main/drivers/display_ug2864hsweg01.c"
              ;
}

static 
# 197 "./src/main/drivers/display_ug2864hsweg01.c" 3 4
      _Bool 
# 197 "./src/main/drivers/display_ug2864hsweg01.c"
    ...
    ug2864hsweg01InitI2C(busDevice_t *bus)
{
    ...
    if (!i2c_OLED_send_cmd(bus, 0xAE)) {
        return 
# 286 "./src/main/drivers/display_ug2864hsweg01.c" 3 4
              0
# 286 "./src/main/drivers/display_ug2864hsweg01.c"
                   ;
    }
    ...
    return 
# 318 "./src/main/drivers/display_ug2864hsweg01.c" 3 4
          1
# 318 "./src/main/drivers/display_ug2864hsweg01.c"
              ;
}
