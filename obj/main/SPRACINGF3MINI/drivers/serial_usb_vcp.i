...
# 37 "./src/main/drivers/serial_usb_vcp.c"
...
static 
# 68 "./src/main/drivers/serial_usb_vcp.c" 3 4
      _Bool 
# 68 "./src/main/drivers/serial_usb_vcp.c"
           isUsbVcpTransmitBufferEmpty(const serialPort_t *instance)
{
    (void)(instance);
    return 
# 71 "./src/main/drivers/serial_usb_vcp.c" 3 4
          1
# 71 "./src/main/drivers/serial_usb_vcp.c"
              ;
}
...
static uint8_t usbVcpRead(serialPort_t *instance)
{
    ...
    while (
# 87 "./src/main/drivers/serial_usb_vcp.c" 3 4
          1
# 87 "./src/main/drivers/serial_usb_vcp.c"
              ) {
...
static 
# 114 "./src/main/drivers/serial_usb_vcp.c" 3 4
      _Bool 
# 114 "./src/main/drivers/serial_usb_vcp.c"
           usbVcpFlush(vcpPort_t *port)
{
    ...
    if (count == 0) {
        return 
# 120 "./src/main/drivers/serial_usb_vcp.c" 3 4
              1
# 120 "./src/main/drivers/serial_usb_vcp.c"
                  ;
    }

    if (!usbIsConnected() || !usbIsConfigured()) {
        return 
# 124 "./src/main/drivers/serial_usb_vcp.c" 3 4
              0
# 124 "./src/main/drivers/serial_usb_vcp.c"
                   ;
    }
...
# 143 "./src/main/drivers/serial_usb_vcp.c" 3 4
                     __builtin_offsetof (
# 143 "./src/main/drivers/serial_usb_vcp.c"
                     vcpPort_t
# 143 "./src/main/drivers/serial_usb_vcp.c" 3 4
                     , 
# 143 "./src/main/drivers/serial_usb_vcp.c"
...
{
    vcpPort_t *port = ( __extension__ ({ const typeof( ((vcpPort_t *)0)->port ) *__mptr = (instance); (vcpPort_t *)( (char *)__mptr - 
# 153 "./src/main/drivers/serial_usb_vcp.c" 3 4
                     __builtin_offsetof (
# 153 "./src/main/drivers/serial_usb_vcp.c"
                     vcpPort_t
# 153 "./src/main/drivers/serial_usb_vcp.c" 3 4
                     , 
# 153 "./src/main/drivers/serial_usb_vcp.c"
...
# 153 "./src/main/drivers/serial_usb_vcp.c"
    ...
    port->buffering = 
# 154 "./src/main/drivers/serial_usb_vcp.c" 3 4
                     1
# 154 "./src/main/drivers/serial_usb_vcp.c"
                         ;
}
...
{
    vcpPort_t *port = ( __extension__ ({ const typeof( ((vcpPort_t *)0)->port ) *__mptr = (instance); (vcpPort_t *)( (char *)__mptr - 
# 165 "./src/main/drivers/serial_usb_vcp.c" 3 4
                     __builtin_offsetof (
# 165 "./src/main/drivers/serial_usb_vcp.c"
                     vcpPort_t
# 165 "./src/main/drivers/serial_usb_vcp.c" 3 4
                     , 
# 165 "./src/main/drivers/serial_usb_vcp.c"
...
# 165 "./src/main/drivers/serial_usb_vcp.c"
    ...
    port->buffering = 
# 166 "./src/main/drivers/serial_usb_vcp.c" 3 4
                     0
# 166 "./src/main/drivers/serial_usb_vcp.c"
                          ;
    usbVcpFlush(port);
}
...
{
    vcpPort_t *s;
# 212 "./src/main/drivers/serial_usb_vcp.c"
    Set_System();
    Set_USBClock();
    USB_Init();
