...
static IO_t sdCardDetectPin = ((IO_t)0);
...
void sdcardInsertionDetectDeinit(void)
{
    ...
    sdCardDetectPin = IOGetByTag(((ioTag_t)((((2) + 1) << 4) | (14))));
    IOInit(sdCardDetectPin, OWNER_FREE, 0);
    IOConfigGPIO(sdCardDetectPin, ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
...
void sdcardInsertionDetectInit(void)
{
    ...
    IOConfigGPIO(sdCardDetectPin, ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_UP) << 5)));
...
# 143 "./src/main/drivers/sdcard.c" 3 4
_Bool 
# 143 "./src/main/drivers/sdcard.c"
    sdcard_isInserted(void)
{
    
# 145 "./src/main/drivers/sdcard.c" 3 4
   _Bool 
# 145 "./src/main/drivers/sdcard.c"
        result = 
# 145 "./src/main/drivers/sdcard.c" 3 4
                 1
# 145 "./src/main/drivers/sdcard.c"
...
static void sdcard_deselect(void)
{
    ...
    while (spiIsBusBusy(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)))) {
    }
...
static void sdcard_reset(void)
{
    ...
    if (sdcard.state >= SDCARD_STATE_READY) {
        spiSetDivisor(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)), 128);
    }
...
static 
# 216 "./src/main/drivers/sdcard.c" 3 4
      _Bool 
# 216 "./src/main/drivers/sdcard.c"
           sdcard_waitForIdle(int maxBytesToWait)
{
    while (maxBytesToWait > 0) {
        uint8_t b = spiTransferByte(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)), 0xFF);
        if (b == 0xFF) {
            return 
# 221 "./src/main/drivers/sdcard.c" 3 4
                  1
# 221 "./src/main/drivers/sdcard.c"
                      ;
        }
        maxBytesToWait--;
    }
    ...
    return 
# 226 "./src/main/drivers/sdcard.c" 3 4
          0
# 226 "./src/main/drivers/sdcard.c"
               ;
}
...
static uint8_t sdcard_waitForNonIdleByte(int maxDelay)
{
    for (int i = 0; i < maxDelay + 1; i++) {
        uint8_t response = spiTransferByte(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)), 0xFF);
...
static uint8_t sdcard_sendCommand(uint8_t commandCode, uint32_t commandArgument)
{
    ...
    spiTransfer(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)), command, 
# 272 "./src/main/drivers/sdcard.c" 3 4
                                             ((void *)0)
# 272 "./src/main/drivers/sdcard.c"
                                                 , sizeof(command));
...
static 
# 292 "./src/main/drivers/sdcard.c" 3 4
      _Bool 
# 292 "./src/main/drivers/sdcard.c"
...
# 308 "./src/main/drivers/sdcard.c" 3 4
                                        ((void *)0)
# 308 "./src/main/drivers/sdcard.c"
...
static 
# 324 "./src/main/drivers/sdcard.c" 3 4
      _Bool 
# 324 "./src/main/drivers/sdcard.c"
           sdcard_readOCRRegister(uint32_t *result)
{
    ...
    spiTransfer(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)), 
# 332 "./src/main/drivers/sdcard.c" 3 4
                                    ((void *)0)
# 332 "./src/main/drivers/sdcard.c"
    ...
    if (status == 0) {
        ...
        *result = (response[0] << 24) | (response[1] << 16) | (response[2] << 8) | response[3];
        ...
        return 
# 339 "./src/main/drivers/sdcard.c" 3 4
              1
# 339 "./src/main/drivers/sdcard.c"
                  ;
    } else {
        sdcard_deselect();

        return 
# 343 "./src/main/drivers/sdcard.c" 3 4
              0
# 343 "./src/main/drivers/sdcard.c"
                   ;
    }
}
...
# 370 "./src/main/drivers/sdcard.c"
    ...
    spiTransferByte(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)), 0xFF);
    spiTransferByte(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)), 0xFF);
...
static 
# 379 "./src/main/drivers/sdcard.c" 3 4
      _Bool 
# 379 "./src/main/drivers/sdcard.c"
           sdcard_sendDataBlockFinish(void)
{

    spiTransferByte(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)), 0x00);
    spiTransferByte(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)), 0x00);

    uint8_t dataResponseToken = spiTransferByte(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)), 0xFF);
# 399 "./src/main/drivers/sdcard.c"
...
# 405 "./src/main/drivers/sdcard.c" 3 4
                                                            _Bool 
# 405 "./src/main/drivers/sdcard.c"
                                                                 multiBlockWrite)
{

    spiTransferByte(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)), 0xFF);

    spiTransferByte(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)), multiBlockWrite ? 0xFC : 0xFE);

    if (useDMAForTx) {
# 450 "./src/main/drivers/sdcard.c"
        ...
        init.DMA_PeripheralBaseAddr = (uint32_t) &((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800))->DR;
        ...
        DMA_DeInit(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000058)));
        DMA_Init(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000058)), &init);

        DMA_Cmd(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000058)), ENABLE);

        SPI_I2S_DMACmd(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)), ((uint16_t)0x0002), ENABLE);

    } else {

        spiTransfer(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)), buffer, 
...
static 
# 486 "./src/main/drivers/sdcard.c" 3 4
      _Bool 
# 486 "./src/main/drivers/sdcard.c"
           sdcard_receiveCID(void)
{
    ...
    if (sdcard_receiveDataBlock(cid, sizeof(cid)) != SDCARD_RECEIVE_SUCCESS) {
        return 
# 491 "./src/main/drivers/sdcard.c" 3 4
              0
# 491 "./src/main/drivers/sdcard.c"
                   ;
    }
    ...
    return 
# 507 "./src/main/drivers/sdcard.c" 3 4
          1
# 507 "./src/main/drivers/sdcard.c"
              ;
}

static 
# 510 "./src/main/drivers/sdcard.c" 3 4
      _Bool 
# 510 "./src/main/drivers/sdcard.c"
...
# 520 "./src/main/drivers/sdcard.c" 3 4
   _Bool 
# 520 "./src/main/drivers/sdcard.c"
        success =
    ...
    if (success) {
        switch (readBitfield(sdcard.csd.data, 0, 2)) {
            ...
            default:
                success = 
# 543 "./src/main/drivers/sdcard.c" 3 4
                         0
# 543 "./src/main/drivers/sdcard.c"
                              ;
        }
    }
...
static 
# 557 "./src/main/drivers/sdcard.c" 3 4
      _Bool 
# 557 "./src/main/drivers/sdcard.c"
...
void sdcard_init(
# 572 "./src/main/drivers/sdcard.c" 3 4
                _Bool 
# 572 "./src/main/drivers/sdcard.c"
                     useDMA)
{
    ...
    useDMAForTx = useDMA;
    if (useDMAForTx) {
        dmaInit(dmaGetIdentifier(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000058))), OWNER_SDCARD, 0);
    }
    ...
    sdCardCsPin = IOGetByTag(((ioTag_t)((((1) + 1) << 4) | (12))));
    IOInit(sdCardCsPin, OWNER_SDCARD_CS, 0);
    IOConfigGPIO(sdCardCsPin, ((GPIO_Mode_OUT) | ((GPIO_Speed_Level_3) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
    ...
    spiTransfer(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)), 
# 604 "./src/main/drivers/sdcard.c" 3 4
                                    ((void *)0)
# 604 "./src/main/drivers/sdcard.c"
                                        , 
# 604 "./src/main/drivers/sdcard.c" 3 4
                                          ((void *)0)
# 604 "./src/main/drivers/sdcard.c"
...
static 
# 621 "./src/main/drivers/sdcard.c" 3 4
      _Bool 
# 621 "./src/main/drivers/sdcard.c"
...
static 
# 635 "./src/main/drivers/sdcard.c" 3 4
      _Bool 
# 635 "./src/main/drivers/sdcard.c"
           sdcard_isReady(void)
{
    return sdcard.state == SDCARD_STATE_READY || sdcard.state == SDCARD_STATE_WRITING_MULTIPLE_BLOCKS;
}
# 650 "./src/main/drivers/sdcard.c"
static sdcardOperationStatus_e sdcard_endWriteBlocks(void)
{
    ...
    spiTransferByte(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)), 0xFD);
        ...
        case SDCARD_STATE_CARD_INIT_IN_PROGRESS:
            if (sdcard_checkInitDone()) {
                if (sdcard.version == 2) {
                    ...
                    sdcard.highCapacity = 
# 721 "./src/main/drivers/sdcard.c" 3 4
                                         0
# 721 "./src/main/drivers/sdcard.c"
                                              ;
                }
        ...
        case SDCARD_STATE_SENDING_WRITE:
            ...
            sendComplete = 
# 766 "./src/main/drivers/sdcard.c" 3 4
                          0
# 766 "./src/main/drivers/sdcard.c"
                               ;
# 789 "./src/main/drivers/sdcard.c"
            if (useDMAForTx && DMA_GetFlagStatus(((uint32_t)0x00020000)) == SET) {
                DMA_ClearFlag(((uint32_t)0x00020000));


                DMA_Cmd(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000058)), DISABLE);


                while (SPI_I2S_GetFlagStatus(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)), ((uint16_t)0x0001)) == SET) {
                    ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800))->DR;
                }
                ...
                SPI_I2S_DMACmd(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)), ((uint16_t)0x0002), DISABLE);

                sendComplete = 
# 806 "./src/main/drivers/sdcard.c" 3 4
                              1
# 806 "./src/main/drivers/sdcard.c"
                                  ;
            }

            if (!useDMAForTx) {

                spiTransfer(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)), sdcard.pendingOperation.buffer + 256 * sdcard.pendingOperation.chunkIndex, 
# 811 "./src/main/drivers/sdcard.c" 3 4
                                                                                                                                                 ((void *)0)
# 811 "./src/main/drivers/sdcard.c"
                                                                                                                                                     , 256);
...
# 837 "./src/main/drivers/sdcard.c" 3 4
                                                                                                                          ((void *)0)
# 837 "./src/main/drivers/sdcard.c"
...
# 925 "./src/main/drivers/sdcard.c" 3 4
                           ((void *)0)
# 925 "./src/main/drivers/sdcard.c"
                               ,
                            sdcard.pendingOperation.callbackData
                        );
                    }
...
# 1045 "./src/main/drivers/sdcard.c"
sdcardOperationStatus_e sdcard_beginWriteBlocks(uint32_t blockIndex, uint32_t blockCount)
{
    if (sdcard.state != SDCARD_STATE_READY) {
...
# 1093 "./src/main/drivers/sdcard.c"

# 1093 "./src/main/drivers/sdcard.c" 3 4
_Bool 
# 1093 "./src/main/drivers/sdcard.c"
    sdcard_readBlock(uint32_t blockIndex, uint8_t *buffer, sdcard_operationCompleteCallback_c callback, uint32_t callbackData)
{
    if (sdcard.state != SDCARD_STATE_READY) {
        if (sdcard.state == SDCARD_STATE_WRITING_MULTIPLE_BLOCKS) {
            if (sdcard_endWriteBlocks() != SDCARD_OPERATION_SUCCESS) {
                return 
# 1098 "./src/main/drivers/sdcard.c" 3 4
                      0
# 1098 "./src/main/drivers/sdcard.c"
                           ;
            }
        } else {
            return 
# 1101 "./src/main/drivers/sdcard.c" 3 4
                  0
# 1101 "./src/main/drivers/sdcard.c"
                       ;
        }
    }
    ...
    if (status == 0) {
        ...
        return 
# 1126 "./src/main/drivers/sdcard.c" 3 4
              1
# 1126 "./src/main/drivers/sdcard.c"
                  ;
    } else {
        sdcard_deselect();

        return 
# 1130 "./src/main/drivers/sdcard.c" 3 4
              0
# 1130 "./src/main/drivers/sdcard.c"
                   ;
    }
}
