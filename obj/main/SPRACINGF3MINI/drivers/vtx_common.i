    ...
    vtxCommonGetBandAndChannel(uint8_t *pBand, uint8_t *pChannel)
{
    if (!vtxDevice)
        return 
# 116 "./src/main/drivers/vtx_common.c" 3 4
              0
# 116 "./src/main/drivers/vtx_common.c"
                   ;
...
# 124 "./src/main/drivers/vtx_common.c" 3 4
_Bool 
# 124 "./src/main/drivers/vtx_common.c"
    vtxCommonGetPowerIndex(uint8_t *pIndex)
{
    if (!vtxDevice)
        return 
# 127 "./src/main/drivers/vtx_common.c" 3 4
              0
# 127 "./src/main/drivers/vtx_common.c"
                   ;
    ...
    if (vtxDevice->vTable->getPowerIndex)
        ...
        return 
# 132 "./src/main/drivers/vtx_common.c" 3 4
              0
# 132 "./src/main/drivers/vtx_common.c"
                   ;
}
...
# 138 "./src/main/drivers/vtx_common.c"
    ...
    if (vtxDevice->vTable->getPitMode)
        ...
        return 
# 143 "./src/main/drivers/vtx_common.c" 3 4
              0
# 143 "./src/main/drivers/vtx_common.c"
                   ;
}


# 146 "./src/main/drivers/vtx_common.c" 3 4
_Bool 
# 146 "./src/main/drivers/vtx_common.c"
    vtxCommonGetFrequency(uint16_t *pFreq)
{
    if (!vtxDevice) {
        return 
...
# 149 "./src/main/drivers/vtx_common.c"
    ...
    if (vtxDevice->vTable->getFrequency) {
        ...
        return 
# 154 "./src/main/drivers/vtx_common.c" 3 4
              0
# 154 "./src/main/drivers/vtx_common.c"
                   ;
    }
}


# 158 "./src/main/drivers/vtx_common.c" 3 4
_Bool 
# 158 "./src/main/drivers/vtx_common.c"
    vtxCommonGetDeviceCapability(vtxDeviceCapability_t *pDeviceCapability)
{
    if (!vtxDevice)
        return 
# 161 "./src/main/drivers/vtx_common.c" 3 4
              0
# 161 "./src/main/drivers/vtx_common.c"
                   ;

    memcpy(pDeviceCapability, &vtxDevice->capability, sizeof(vtxDeviceCapability_t));
    return 
# 164 "./src/main/drivers/vtx_common.c" 3 4
          1
# 164 "./src/main/drivers/vtx_common.c"
              ;
}
