...
# 27 "./src/main/drivers/pwm_output_dshot.c" 2



# 1 "./src/main/drivers/timer_stm32f30x.h" 1
# 18 "./src/main/drivers/timer_stm32f30x.h"
       
# 31 "./src/main/drivers/pwm_output_dshot.c" 2
...
# 34 "./src/main/drivers/pwm_output_dshot.c" 2
...
void pwmDshotMotorHardwareConfig(const timerHardware_t *timerHardware, uint8_t motorIndex, motorPwmProtocolTypes_e pwmProtocolType, uint8_t output)
{
    ...
    const 
# 107 "./src/main/drivers/pwm_output_dshot.c" 3 4
         _Bool 
# 107 "./src/main/drivers/pwm_output_dshot.c"
              configureTimer = (timerIndex == dmaMotorTimerCount-1);

    IOInit(motorIO, OWNER_MOTOR, (motorIndex + 1));
...
# 186 "./src/main/drivers/pwm_output_dshot.c"
