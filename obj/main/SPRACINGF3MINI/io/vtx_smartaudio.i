...
# 10 "/home/nirigan3/icarus/cleanflight/tools/gcc-arm-none-eabi-6-2017-q2-update/arm-none-eabi/include/string.h" 3
...
# 11 "/home/nirigan3/icarus/cleanflight/tools/gcc-arm-none-eabi-6-2017-q2-update/arm-none-eabi/include/string.h" 2 3
...
# 12 "/home/nirigan3/icarus/cleanflight/tools/gcc-arm-none-eabi-6-2017-q2-update/arm-none-eabi/include/string.h" 2 3
...
# 13 "/home/nirigan3/icarus/cleanflight/tools/gcc-arm-none-eabi-6-2017-q2-update/arm-none-eabi/include/string.h" 2 3
...
# 41 "./src/main/io/vtx_smartaudio.c" 2
...
# 67 "./src/main/drivers/vtx_common.h" 3 4
   _Bool 
...
# 74 "./src/main/drivers/vtx_common.h" 3 4
   _Bool 
# 74 "./src/main/drivers/vtx_common.h"
        (*getBandAndChannel)(uint8_t *pBand, uint8_t *pChannel);
    
# 75 "./src/main/drivers/vtx_common.h" 3 4
   _Bool 
# 75 "./src/main/drivers/vtx_common.h"
        (*getPowerIndex)(uint8_t *pIndex);
    
# 76 "./src/main/drivers/vtx_common.h" 3 4
   _Bool 
# 76 "./src/main/drivers/vtx_common.h"
        (*getPitMode)(uint8_t *pOnOff);
    
# 77 "./src/main/drivers/vtx_common.h" 3 4
   _Bool 
# 77 "./src/main/drivers/vtx_common.h"
...
# 87 "./src/main/drivers/vtx_common.h" 3 4
_Bool 
# 87 "./src/main/drivers/vtx_common.h"
...
# 96 "./src/main/drivers/vtx_common.h" 3 4
_Bool 
# 96 "./src/main/drivers/vtx_common.h"
    vtxCommonGetBandAndChannel(uint8_t *pBand, uint8_t *pChannel);

# 97 "./src/main/drivers/vtx_common.h" 3 4
_Bool 
# 97 "./src/main/drivers/vtx_common.h"
    vtxCommonGetPowerIndex(uint8_t *pIndex);

# 98 "./src/main/drivers/vtx_common.h" 3 4
_Bool 
# 98 "./src/main/drivers/vtx_common.h"
    vtxCommonGetPitMode(uint8_t *pOnOff);

# 99 "./src/main/drivers/vtx_common.h" 3 4
_Bool 
# 99 "./src/main/drivers/vtx_common.h"
    vtxCommonGetFrequency(uint16_t *pFreq);

# 100 "./src/main/drivers/vtx_common.h" 3 4
_Bool 
# 100 "./src/main/drivers/vtx_common.h"
...
extern 
# 92 "./src/main/io/vtx_smartaudio.h" 3 4
      _Bool 
# 92 "./src/main/io/vtx_smartaudio.h"
           saDeferred;
...
# 100 "./src/main/io/vtx_smartaudio.h" 3 4
_Bool 
# 100 "./src/main/io/vtx_smartaudio.h"
...
# 65 "./src/main/io/vtx_smartaudio.c"
static serialPort_t *smartAudioSerialPort = 
# 65 "./src/main/io/vtx_smartaudio.c" 3 4
                                           ((void *)0)
# 65 "./src/main/io/vtx_smartaudio.c"
                                               ;


static const char * const saPowerNames[4 +1] = {
    "---", "25 ", "200", "500", "800",
};
...
# 114 "./src/main/io/vtx_smartaudio.c"
...
# 150 "./src/main/io/vtx_smartaudio.c" 3 4
_Bool 
# 150 "./src/main/io/vtx_smartaudio.c"
    saDeferred = 
# 150 "./src/main/io/vtx_smartaudio.c" 3 4
                 1
# 150 "./src/main/io/vtx_smartaudio.c"
...
static saCmdQueue_t sa_queue[4];
static uint8_t sa_qhead = 0;
static uint8_t sa_qtail = 0;
# 515 "./src/main/io/vtx_smartaudio.c"
static 
# 515 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 515 "./src/main/io/vtx_smartaudio.c"
           saQueueEmpty(void)
{
...
static 
# 520 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 520 "./src/main/io/vtx_smartaudio.c"
           saQueueFull(void)
{
    return ((sa_qhead + 1) % 4) == sa_qtail;
}
...
static 
# 555 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 555 "./src/main/io/vtx_smartaudio.c"
...
static 
# 670 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 670 "./src/main/io/vtx_smartaudio.c"
           saEnterInitBandChanAndPower(uint8_t band, uint8_t channel, uint8_t power)
{
    if (!saValidateBandAndChannel(band, channel)) {
        return 
# 673 "./src/main/io/vtx_smartaudio.c" 3 4
              0
# 673 "./src/main/io/vtx_smartaudio.c"
                   ;
    }
    saDevSetBandAndChannel(band - 1, channel - 1);

    uint8_t pwrIdx = constrain(power - 1, 0, 4 - 1);
...
# 701 "./src/main/io/vtx_smartaudio.c" 3 4
_Bool 
# 701 "./src/main/io/vtx_smartaudio.c"
    vtxSmartAudioInit(void)
{
...
# 722 "./src/main/io/vtx_smartaudio.c" 3 4
                                                                                              ((void *)0)
# 722 "./src/main/io/vtx_smartaudio.c"
                                                                                                  , 4800, MODE_RXTX, portOptions);
    }

    if (!smartAudioSerialPort) {
        return 
# 726 "./src/main/io/vtx_smartaudio.c" 3 4
              0
# 726 "./src/main/io/vtx_smartaudio.c"
                   ;
    }
...
void vtxSAProcess(uint32_t now)
{
    ...
    static 
# 737 "./src/main/io/vtx_smartaudio.c" 3 4
          _Bool 
# 737 "./src/main/io/vtx_smartaudio.c"
...
# 737 "./src/main/io/vtx_smartaudio.c"
    ...
    if (smartAudioSerialPort == 
# 739 "./src/main/io/vtx_smartaudio.c" 3 4
                               ((void *)0)
# 739 "./src/main/io/vtx_smartaudio.c"
                                   ) {
        return;
    }
    ...
    if ((sa_outstanding != SA_CMD_NONE) && (now - sa_lastTransmission > 120)) {
...
# 821 "./src/main/io/vtx_smartaudio.c"
}
...
# 831 "./src/main/io/vtx_smartaudio.c" 3 4
_Bool 
# 831 "./src/main/io/vtx_smartaudio.c"
    vtxSAIsReady(void)
{
...
# 887 "./src/main/io/vtx_smartaudio.c" 3 4
_Bool 
# 887 "./src/main/io/vtx_smartaudio.c"
    vtxSAGetBandAndChannel(uint8_t *pBand, uint8_t *pChannel)
{
    if (!vtxSAIsReady()) {
        return 
# 890 "./src/main/io/vtx_smartaudio.c" 3 4
              0
# 890 "./src/main/io/vtx_smartaudio.c"
                   ;
    }
    ...
    *pChannel = ((saDevice.channel) % (uint8_t)8) + 1;
    return 
# 897 "./src/main/io/vtx_smartaudio.c" 3 4
          1
# 897 "./src/main/io/vtx_smartaudio.c"
              ;
}


# 900 "./src/main/io/vtx_smartaudio.c" 3 4
_Bool 
# 900 "./src/main/io/vtx_smartaudio.c"
    vtxSAGetPowerIndex(uint8_t *pIndex)
{
    if (!vtxSAIsReady()) {
        return 
# 903 "./src/main/io/vtx_smartaudio.c" 3 4
              0
# 903 "./src/main/io/vtx_smartaudio.c"
                   ;
    }

    *pIndex = ((saDevice.version == 1) ? saDacToPowerIndex(saDevice.power) : saDevice.power) + 1;
    return 
# 907 "./src/main/io/vtx_smartaudio.c" 3 4
          1
# 907 "./src/main/io/vtx_smartaudio.c"
              ;
}


# 910 "./src/main/io/vtx_smartaudio.c" 3 4
_Bool 
# 910 "./src/main/io/vtx_smartaudio.c"
    vtxSAGetPitMode(uint8_t *pOnOff)
{
    if (!(vtxSAIsReady() && (saDevice.version == 2))) {
        return 
# 913 "./src/main/io/vtx_smartaudio.c" 3 4
              0
# 913 "./src/main/io/vtx_smartaudio.c"
                   ;
    }

    *pOnOff = (saDevice.mode & 2) ? 1 : 0;
    return 
# 917 "./src/main/io/vtx_smartaudio.c" 3 4
          1
# 917 "./src/main/io/vtx_smartaudio.c"
              ;
}


# 920 "./src/main/io/vtx_smartaudio.c" 3 4
_Bool 
# 920 "./src/main/io/vtx_smartaudio.c"
    vtxSAGetFreq(uint16_t *pFreq)
{
    if (!vtxSAIsReady()) {
        return 
# 923 "./src/main/io/vtx_smartaudio.c" 3 4
              0
# 923 "./src/main/io/vtx_smartaudio.c"
                   ;
    }
    ...
    *pFreq = (saDevice.mode & 1) ? saDevice.freq :
             vtx58_Bandchan2Freq(((saDevice.channel) / (uint8_t)8) + 1,
                                 ((saDevice.channel) % (uint8_t)8) + 1);
    return 
# 930 "./src/main/io/vtx_smartaudio.c" 3 4
          1
# 930 "./src/main/io/vtx_smartaudio.c"
              ;
}
