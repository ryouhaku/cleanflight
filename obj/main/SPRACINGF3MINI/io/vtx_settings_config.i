# 1 "./src/main/io/vtx_settings_config.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/io/vtx_settings_config.c"
# 18 "./src/main/io/vtx_settings_config.c"
...
# 19 "./src/main/io/vtx_settings_config.c" 2
...
# 23 "./src/main/io/vtx_settings_config.c" 2
...
# 25 "./src/main/io/vtx_settings_config.c" 2
...
# 26 "./src/main/io/vtx_settings_config.c" 2
...
const vtxSettingsConfig_t pgResetTemplate_vtxSettingsConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .band = 4, .channel = 1, .power = 1, .freq = 0 }
...
static 
# 38 "./src/main/io/vtx_settings_config.c" 3 4
      _Bool 
# 38 "./src/main/io/vtx_settings_config.c"
           vtxChangePending = 
# 38 "./src/main/io/vtx_settings_config.c" 3 4
                              0
# 38 "./src/main/io/vtx_settings_config.c"
...
static void vtxChangeSetting(
# 40 "./src/main/io/vtx_settings_config.c" 3 4
                            _Bool 
# 40 "./src/main/io/vtx_settings_config.c"
                                 changed)
{
    if (changed && !vtxChangePending) {
        vtxChangePending = 
# 43 "./src/main/io/vtx_settings_config.c" 3 4
                          1
# 43 "./src/main/io/vtx_settings_config.c"
                              ;
    }
}

static 
# 47 "./src/main/io/vtx_settings_config.c" 3 4
      _Bool 
# 47 "./src/main/io/vtx_settings_config.c"
           vtxSetBand(uint8_t band)
{
    if (band != vtxSettingsConfig()->band) {
        vtxSettingsConfigMutable()->band = band;
        return 
# 51 "./src/main/io/vtx_settings_config.c" 3 4
              1
# 51 "./src/main/io/vtx_settings_config.c"
                  ;
    }
    return 
# 53 "./src/main/io/vtx_settings_config.c" 3 4
          0
# 53 "./src/main/io/vtx_settings_config.c"
               ;
}

static 
# 56 "./src/main/io/vtx_settings_config.c" 3 4
      _Bool 
# 56 "./src/main/io/vtx_settings_config.c"
           vtxSetChannel(uint8_t channel)
{
    if (channel != vtxSettingsConfig()->channel) {
        vtxSettingsConfigMutable()->channel = channel;
        return 
# 60 "./src/main/io/vtx_settings_config.c" 3 4
              1
# 60 "./src/main/io/vtx_settings_config.c"
                  ;
    }
    return 
# 62 "./src/main/io/vtx_settings_config.c" 3 4
          0
# 62 "./src/main/io/vtx_settings_config.c"
               ;
}

static 
# 65 "./src/main/io/vtx_settings_config.c" 3 4
      _Bool 
# 65 "./src/main/io/vtx_settings_config.c"
           vtxSetFreq(uint16_t freq)
{
    if (freq && freq != vtxSettingsConfig()->freq) {
        ...
        return 
# 77 "./src/main/io/vtx_settings_config.c" 3 4
              1
# 77 "./src/main/io/vtx_settings_config.c"
                  ;
    }
    return 
# 79 "./src/main/io/vtx_settings_config.c" 3 4
          0
# 79 "./src/main/io/vtx_settings_config.c"
               ;
}

static 
# 82 "./src/main/io/vtx_settings_config.c" 3 4
      _Bool 
# 82 "./src/main/io/vtx_settings_config.c"
           vtxSetPower(uint8_t powerIndex)
{
    if (powerIndex != vtxSettingsConfig()->power) {
        vtxSettingsConfigMutable()->power = powerIndex;
        return 
# 86 "./src/main/io/vtx_settings_config.c" 3 4
              1
# 86 "./src/main/io/vtx_settings_config.c"
                  ;
    }
    return 
# 88 "./src/main/io/vtx_settings_config.c" 3 4
          0
# 88 "./src/main/io/vtx_settings_config.c"
               ;
}
...
static void vtxCommitChanges(void)
{
    ...
    vtxChangePending = 
# 96 "./src/main/io/vtx_settings_config.c" 3 4
                      0
# 96 "./src/main/io/vtx_settings_config.c"
                           ;
}
