...
# 24 "./src/main/io/rcdevice_osd.c" 2
...
# 25 "./src/main/io/rcdevice_osd.c" 2
...
# 49 "./src/main/io/rcdevice_osd.c"

# 49 "./src/main/io/rcdevice_osd.c" 3 4
_Bool 
# 49 "./src/main/io/rcdevice_osd.c"
...
# 52 "./src/main/io/rcdevice_osd.c"
    ...
    if ((osdDevice->info.features & RCDEVICE_PROTOCOL_FEATURE_DISPLAYP_PORT) == 0) {
        return 
# 56 "./src/main/io/rcdevice_osd.c" 3 4
              0
# 56 "./src/main/io/rcdevice_osd.c"
                   ;
    }
    ...
    if (!runcamDeviceGetSettingDetail(osdDevice, RCDEVICE_PROTOCOL_SETTINGID_DISP_COLUMNS, &settingDetail)) {
        return 
# 62 "./src/main/io/rcdevice_osd.c" 3 4
              0
# 62 "./src/main/io/rcdevice_osd.c"
                   ;
    }
    ...
    if (video_system == VIDEO_SYSTEM_AUTO) {
        ...
        if (!runcamDeviceGetSettingDetail(osdDevice, RCDEVICE_PROTOCOL_SETTINGID_DISP_TV_MODE, &settingDetail)) {
            return 
# 72 "./src/main/io/rcdevice_osd.c" 3 4
                  0
# 72 "./src/main/io/rcdevice_osd.c"
                       ;
        }
        ...
        if (!runcamDeviceWriteSetting(osdDevice, RCDEVICE_PROTOCOL_SETTINGID_DISP_TV_MODE, &tvMode, sizeof(uint8_t), &response)) {
            return 
# 86 "./src/main/io/rcdevice_osd.c" 3 4
                  0
# 86 "./src/main/io/rcdevice_osd.c"
                       ;
        }

        if (response.resultCode) {
            return 
# 90 "./src/main/io/rcdevice_osd.c" 3 4
                  0
# 90 "./src/main/io/rcdevice_osd.c"
                       ;
        }
    }
    ...
    if (!runcamDeviceWriteSetting(osdDevice, RCDEVICE_PROTOCOL_SETTINGID_DISP_CHARSET, &charsetID, sizeof(uint8_t), &updateCharsetResp) || updateCharsetResp.resultCode != 0) {
        return 
# 98 "./src/main/io/rcdevice_osd.c" 3 4
              0
# 98 "./src/main/io/rcdevice_osd.c"
                   ;
    }
...
# 106 "./src/main/io/rcdevice_osd.c" 3 4
                          ((void *)0)
# 106 "./src/main/io/rcdevice_osd.c"
                              );
    return 
# 107 "./src/main/io/rcdevice_osd.c" 3 4
          1
# 107 "./src/main/io/rcdevice_osd.c"
              ;
}
...
{
    (void)(displayPort);
# 157 "./src/main/io/rcdevice_osd.c"
    return 0;
}
...
# 198 "./src/main/io/rcdevice_osd.c" 3 4
_Bool 
# 198 "./src/main/io/rcdevice_osd.c"
...
uint32_t rcdeviceOSDTxBytesFree(const displayPort_t *displayPort)
{
    (void)(displayPort);
    return 
# 227 "./src/main/io/rcdevice_osd.c" 3 4
          (0x7fffffffL)
# 227 "./src/main/io/rcdevice_osd.c"
                   ;
}
