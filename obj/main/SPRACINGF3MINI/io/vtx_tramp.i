...
# 11 "/home/nirigan3/icarus/cleanflight/tools/gcc-arm-none-eabi-6-2017-q2-update/arm-none-eabi/include/string.h" 3
...
# 56 "./src/main/io/vtx_settings_config.h"
...
static 
# 160 "./src/main/io/vtx_tramp.c" 3 4
      _Bool 
# 160 "./src/main/io/vtx_tramp.c"
...
{
    trampSetByFreqFlag = 
# 173 "./src/main/io/vtx_tramp.c" 3 4
                        0
# 173 "./src/main/io/vtx_tramp.c"
                             ;
    ...
    trampCommitChanges(void)
{
    if (trampStatus != TRAMP_STATUS_ONLINE) {
        return 
# 194 "./src/main/io/vtx_tramp.c" 3 4
              0
# 194 "./src/main/io/vtx_tramp.c"
                   ;
    }

    trampStatus = TRAMP_STATUS_SET_FREQ_PW;
    return 
# 198 "./src/main/io/vtx_tramp.c" 3 4
          1
# 198 "./src/main/io/vtx_tramp.c"
              ;
}
           ...
           trampDevSetPowerByIndex(uint8_t index)
{
    if (index > 0 && index <= sizeof(trampPowerTable)) {
        ...
        trampCommitChanges();
        return 
# 207 "./src/main/io/vtx_tramp.c" 3 4
              1
# 207 "./src/main/io/vtx_tramp.c"
                  ;
    }
    return 
    ...
    case 'v':
        {
            ...
            if (freq != 0) {
                ...
                if (!vtx58_Freq2Bandchan(trampCurFreq, &trampBand, &trampChannel)) {
                    trampSetByFreqFlag = 
# 248 "./src/main/io/vtx_tramp.c" 3 4
                                        1
# 248 "./src/main/io/vtx_tramp.c"
                                            ;
                }
           ...
           trampIsValidResponseCode(uint8_t code)
{
    if (code == 'r' || code == 'v' || code == 's') {
        return 
# 292 "./src/main/io/vtx_tramp.c" 3 4
              1
# 292 "./src/main/io/vtx_tramp.c"
                  ;
    } else {
        return 
...
# 370 "./src/main/io/vtx_tramp.c"
           trampEnterInitBandChanAndPower(uint8_t band, uint8_t channel, uint8_t power)
{
    if (!trampValidateBandAndChannel(band, channel)) {
        return 
# 373 "./src/main/io/vtx_tramp.c" 3 4
              0
# 373 "./src/main/io/vtx_tramp.c"
                   ;
    }
    trampSetByFreqFlag = 
# 375 "./src/main/io/vtx_tramp.c" 3 4
                        0
# 375 "./src/main/io/vtx_tramp.c"
                             ;
    trampDevSetBandAndChannel(band, channel);
    ...
    return 
# 385 "./src/main/io/vtx_tramp.c" 3 4
          1
# 385 "./src/main/io/vtx_tramp.c"
              ;
}
...
static void trampEnterInitFreqAndPower(uint16_t freq, uint8_t power)
{
    if (trampValidateFreq(freq)) {
        trampSetByFreqFlag = 
# 391 "./src/main/io/vtx_tramp.c" 3 4
                            1
# 391 "./src/main/io/vtx_tramp.c"
                                ;
        trampDevSetFreq(freq);
    }
...
void vtxTrampProcess(uint32_t currentTimeUs)
{
    ...
    static 
# 405 "./src/main/io/vtx_tramp.c" 3 4
          _Bool 
# 405 "./src/main/io/vtx_tramp.c"
    ...
    case 'r':
        if (trampStatus <= TRAMP_STATUS_OFFLINE) {
            ...
            if (!initSettingsDoneFlag) {
                initSettingsDoneFlag = 
# 429 "./src/main/io/vtx_tramp.c" 3 4
                                      1
# 429 "./src/main/io/vtx_tramp.c"
                                          ;
...
# 472 "./src/main/io/vtx_tramp.c" 3 4
           _Bool 
# 472 "./src/main/io/vtx_tramp.c"
                done = 
# 472 "./src/main/io/vtx_tramp.c" 3 4
                       1
# 472 "./src/main/io/vtx_tramp.c"
...
# 479 "./src/main/io/vtx_tramp.c" 3 4
                      0
# 479 "./src/main/io/vtx_tramp.c"
                           ;
...
# 486 "./src/main/io/vtx_tramp.c" 3 4
                      0
# 486 "./src/main/io/vtx_tramp.c"
                           ;
            }
...
# 583 "./src/main/io/vtx_tramp.c" 3 4
_Bool 
# 583 "./src/main/io/vtx_tramp.c"
    vtxTrampGetPowerIndex(uint8_t *pIndex)
{
    if (!vtxTrampIsReady()) {
        return 
# 586 "./src/main/io/vtx_tramp.c" 3 4
              0
# 586 "./src/main/io/vtx_tramp.c"
                   ;
    }
    ...
    return 
# 598 "./src/main/io/vtx_tramp.c" 3 4
          1
# 598 "./src/main/io/vtx_tramp.c"
              ;
}
...
# 604 "./src/main/io/vtx_tramp.c"
    ...
    *pOnOff = trampPitMode;
    return 
# 608 "./src/main/io/vtx_tramp.c" 3 4
          1
# 608 "./src/main/io/vtx_tramp.c"
              ;
}


# 611 "./src/main/io/vtx_tramp.c" 3 4
_Bool 
# 611 "./src/main/io/vtx_tramp.c"
    vtxTrampGetFreq(uint16_t *pFreq)
{
    if (!vtxTrampIsReady()) {
        return 
# 614 "./src/main/io/vtx_tramp.c" 3 4
              0
# 614 "./src/main/io/vtx_tramp.c"
                   ;
    }

    *pFreq = trampCurFreq;
    return 
# 618 "./src/main/io/vtx_tramp.c" 3 4
          1
# 618 "./src/main/io/vtx_tramp.c"
              ;
}
...
# 637 "./src/main/io/vtx_tramp.c" 3 4
_Bool 
# 637 "./src/main/io/vtx_tramp.c"
    vtxTrampInit(void)
{
...
# 649 "./src/main/io/vtx_tramp.c" 3 4
                                                                                    ((void *)0)
# 649 "./src/main/io/vtx_tramp.c"
                                                                                        , 9600, MODE_RXTX, portOptions);
    }

    if (!trampSerialPort) {
        return 
# 653 "./src/main/io/vtx_tramp.c" 3 4
              0
# 653 "./src/main/io/vtx_tramp.c"
                   ;
    }
    ...
    return 
# 660 "./src/main/io/vtx_tramp.c" 3 4
          1
# 660 "./src/main/io/vtx_tramp.c"
              ;
}
