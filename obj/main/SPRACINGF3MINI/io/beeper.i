...
# 222 "./src/main/io/beeper.c"
     ,"SYSTEM_INIT" },
    { BEEPER_USB,17,
# 223 "./src/main/io/beeper.c" 3 4
     ((void *)0)
# 223 "./src/main/io/beeper.c"
     ,"ON_USB" },
    ...
    { BEEPER_ALL,22,
# 228 "./src/main/io/beeper.c" 3 4
     ((void *)0)
# 228 "./src/main/io/beeper.c"
     ,"ALL" },
    { BEEPER_PREFERENCE,23,
# 229 "./src/main/io/beeper.c" 3 4
     ((void *)0)
# 229 "./src/main/io/beeper.c"
     ,"PREFERRED" },
};

static const beeperTableEntry_t *currentBeeperEntry = 
# 232 "./src/main/io/beeper.c" 3 4
                                                     ((void *)0)
# 232 "./src/main/io/beeper.c"
                                                         ;
...
# 252 "./src/main/io/beeper.c" 3 4
                                                 ((void *)0)
# 252 "./src/main/io/beeper.c"
                                                     ;
...
# 283 "./src/main/io/beeper.c"
    ...
    currentBeeperEntry = 
# 293 "./src/main/io/beeper.c" 3 4
                        ((void *)0)
# 293 "./src/main/io/beeper.c"
                            ;
}
...
void beeperUpdate(timeUs_t currentTimeUs)
{
    ...
    if (currentBeeperEntry == 
# 371 "./src/main/io/beeper.c" 3 4
                             ((void *)0)
# 371 "./src/main/io/beeper.c"
                                 ) {
        return;
    }
...
# 473 "./src/main/io/beeper.c" 3 4
                                                                                      ((void *)0)
# 473 "./src/main/io/beeper.c"
                                                                                          ;
...
# 488 "./src/main/io/beeper.c" 3 4
_Bool 
# 488 "./src/main/io/beeper.c"
    isBeeperOn(void)
{
    return beeperIsOn;
}
