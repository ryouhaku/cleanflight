...
serialPortUsage_t *findSerialPortUsageByIdentifier(serialPortIdentifier_e identifier)
{
    ...
    return 
# 194 "./src/main/io/serial.c" 3 4
          ((void *)0)
# 194 "./src/main/io/serial.c"
              ;
}
...
serialPortConfig_t *findNextSerialPortConfig(serialPortFunction_e function)
{
    ...
    return 
# 230 "./src/main/io/serial.c" 3 4
          ((void *)0)
# 230 "./src/main/io/serial.c"
              ;
}
...
# 245 "./src/main/io/serial.c" 3 4
_Bool 
# 245 "./src/main/io/serial.c"
    isSerialPortShared(const serialPortConfig_t *portConfig, uint16_t functionMask, serialPortFunction_e sharedWithFunction)
{
...
serialPort_t *findNextSharedSerialPort(uint16_t functionMask, serialPortFunction_e sharedWithFunction)
{
    ...
    return 
# 272 "./src/main/io/serial.c" 3 4
          ((void *)0)
# 272 "./src/main/io/serial.c"
              ;
}
...
# 281 "./src/main/io/serial.c" 3 4
_Bool 
# 281 "./src/main/io/serial.c"
...
# 293 "./src/main/io/serial.c"
    ...
    for (int index = 0; index < 6; index++) {
        ...
        if (bitCount > 1) {
            ...
            if (bitCount > 2) {
                return 
# 306 "./src/main/io/serial.c" 3 4
                      0
# 306 "./src/main/io/serial.c"
                           ;
            }
...
serialPortConfig_t *serialFindPortConfiguration(serialPortIdentifier_e identifier)
{
    ...
    return 
# 336 "./src/main/io/serial.c" 3 4
          ((void *)0)
# 336 "./src/main/io/serial.c"
              ;
}


# 339 "./src/main/io/serial.c" 3 4
_Bool 
# 339 "./src/main/io/serial.c"
    doesConfigurationUsePort(serialPortIdentifier_e identifier)
{
    ...
    return candidate != 
# 342 "./src/main/io/serial.c" 3 4
                       ((void *)0) 
# 342 "./src/main/io/serial.c"
...
# 445 "./src/main/io/serial.c" 3 4
                            ((void *)0)
# 445 "./src/main/io/serial.c"
                                ;

    serialPortUsage->function = FUNCTION_NONE;
    serialPortUsage->serialPort = 
# 448 "./src/main/io/serial.c" 3 4
                                 ((void *)0)
# 448 "./src/main/io/serial.c"
                                     ;
}

void serialInit(
# 451 "./src/main/io/serial.c" 3 4
               _Bool 
# 451 "./src/main/io/serial.c"
                    softserialEnabled, serialPortIdentifier_e serialPortToDisable)
{
...
# 500 "./src/main/io/serial.c" 3 4
_Bool 
# 500 "./src/main/io/serial.c"
    serialIsPortAvailable(serialPortIdentifier_e identifier)
{
    for (uint8_t index = 0; index < 6; index++) {
        if (serialPortUsageList[index].identifier == identifier) {
            return 
# 504 "./src/main/io/serial.c" 3 4
                  1
# 504 "./src/main/io/serial.c"
                      ;
        }
    }
    return 
# 507 "./src/main/io/serial.c" 3 4
          0
# 507 "./src/main/io/serial.c"
               ;
}
...
void serialPassthrough(serialPort_t *left, serialPort_t *right, serialConsumer *leftC, serialConsumer *rightC)
{
    ...
    ledSet(0, 
# 553 "./src/main/io/serial.c" 3 4
   0
# 553 "./src/main/io/serial.c"
   );
    ledSet(1, 
...
# 565 "./src/main/io/serial.c"
            ...
            leftC(c);
            ledSet(0, 
# 569 "./src/main/io/serial.c" 3 4
           0
# 569 "./src/main/io/serial.c"
           );
         }
         if (serialRxBytesWaiting(right)) {
             ledSet(0, 
# 572 "./src/main/io/serial.c" 3 4
            1
# 572 "./src/main/io/serial.c"
            );
