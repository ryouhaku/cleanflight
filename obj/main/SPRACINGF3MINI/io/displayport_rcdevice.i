...
# 23 "./src/main/io/displayport_rcdevice.c" 2
...
# 25 "./src/main/io/displayport_rcdevice.c" 2
...
displayPort_t *rcdeviceDisplayPortInit(const vcdProfile_t *vcdProfile)
{
    if (rcdeviceOSDInit(vcdProfile)) {
        ...
        return 
# 54 "./src/main/io/displayport_rcdevice.c" 3 4
              ((void *)0)
# 54 "./src/main/io/displayport_rcdevice.c"
                  ;
    }
}
