...
# 23 "./src/main/fc/rc_controls.h" 2
...
# 40 "./src/main/io/rcdevice_cam.c" 3 4
_Bool 
# 40 "./src/main/io/rcdevice_cam.c"
    rcdeviceInMenu;

# 41 "./src/main/io/rcdevice_cam.c" 3 4
_Bool 
# 41 "./src/main/io/rcdevice_cam.c"
    needRelease = 
# 41 "./src/main/io/rcdevice_cam.c" 3 4
                  0
# 41 "./src/main/io/rcdevice_cam.c"
...
# 69 "./src/main/io/rcdevice_cam.c"
    ...
    if (camDevice->serialPort != 
# 71 "./src/main/io/rcdevice_cam.c" 3 4
                                ((void *)0) 
# 71 "./src/main/io/rcdevice_cam.c"
...
{
    if (camDevice->serialPort != 
# 80 "./src/main/io/rcdevice_cam.c" 3 4
                                ((void *)0) 
# 80 "./src/main/io/rcdevice_cam.c"
...
# 121 "./src/main/io/rcdevice_cam.c" 3 4
                                                       1
# 121 "./src/main/io/rcdevice_cam.c"
                                                           ;
            }
        } else {
            switchStates[switchIndex].isActivated = 
# 124 "./src/main/io/rcdevice_cam.c" 3 4
                                                   0
# 124 "./src/main/io/rcdevice_cam.c"
                                                        ;
        }
    }
}
...
static 
# 129 "./src/main/io/rcdevice_cam.c" 3 4
      _Bool 
# 129 "./src/main/io/rcdevice_cam.c"
...
static 
# 156 "./src/main/io/rcdevice_cam.c" 3 4
      _Bool 
# 156 "./src/main/io/rcdevice_cam.c"
           rcdeviceSend5KeyOSDCableSimualtionEvent(rcdeviceCamSimulationKeyEvent_e key)
{
    
# 158 "./src/main/io/rcdevice_cam.c" 3 4
   _Bool 
# 158 "./src/main/io/rcdevice_cam.c"
        reqResult = 
# 158 "./src/main/io/rcdevice_cam.c" 3 4
                    0
# 158 "./src/main/io/rcdevice_cam.c"
    ...
    case RCDEVICE_CAM_KEY_CONNECTION_OPEN:
        ...
        if (reqResult) {
            rcdeviceInMenu = 
# 163 "./src/main/io/rcdevice_cam.c" 3 4
                            1
# 163 "./src/main/io/rcdevice_cam.c"
                                ;
    ...
    case RCDEVICE_CAM_KEY_CONNECTION_CLOSE: {
        ...
        if (resultCode == 1) {
            rcdeviceInMenu = 
# 171 "./src/main/io/rcdevice_cam.c" 3 4
                            0
# 171 "./src/main/io/rcdevice_cam.c"
                                 ;
...
static void rcdevice5KeySimulationProcess(timeUs_t currentTimeUs)
{
    ...
    if (camDevice->serialPort == 
# 204 "./src/main/io/rcdevice_cam.c" 3 4
                                ((void *)0)
# 204 "./src/main/io/rcdevice_cam.c"
                                    ) {
        return;
    }
    ...
    if (needRelease) {
        if ((rcData[YAW] > 1350 && rcData[YAW] < 1650) && (rcData[PITCH] > 1350 && rcData[PITCH] < 1650) && (rcData[ROLL] > 1350 && rcData[ROLL] < 1650)) {
            ...
            if (rcdeviceSend5KeyOSDCableSimualtionEvent(key)) {
                needRelease = 
# 214 "./src/main/io/rcdevice_cam.c" 3 4
                             0
# 214 "./src/main/io/rcdevice_cam.c"
                                  ;
            } else {
                rcdeviceInMenu = 
# 216 "./src/main/io/rcdevice_cam.c" 3 4
                                0
# 216 "./src/main/io/rcdevice_cam.c"
                                     ;
            }
            return;
        } else {
        ...
        if ((rcData[THROTTLE] > 1350 && rcData[THROTTLE] < 1650) && (rcData[ROLL] > 1350 && rcData[ROLL] < 1650) && (rcData[PITCH] > 1350 && rcData[PITCH] < 1650) && (rcData[YAW] < 1080)) {
            ...
            if (rcdeviceInMenu) {
                ...
                if ((rcData[THROTTLE] > 1350 && rcData[THROTTLE] < 1650) && (rcData[ROLL] > 1350 && rcData[ROLL] < 1650) && (rcData[PITCH] > 1350 && rcData[PITCH] < 1650) && (rcData[YAW] > 1920) && !(armingFlags & (ARMED))) {
    ...
    if (key != RCDEVICE_CAM_KEY_NONE) {
        if (rcdeviceSend5KeyOSDCableSimualtionEvent(key)) {
            needRelease = 
# 250 "./src/main/io/rcdevice_cam.c" 3 4
                         1
# 250 "./src/main/io/rcdevice_cam.c"
                             ;
        } else {
            rcdeviceInMenu = 
# 252 "./src/main/io/rcdevice_cam.c" 3 4
                            0
# 252 "./src/main/io/rcdevice_cam.c"
                                 ;
        }
    }
}
...
# 268 "./src/main/io/rcdevice_cam.c" 3 4
_Bool 
# 268 "./src/main/io/rcdevice_cam.c"
    rcdeviceInit(void)
{

    if (!runcamDeviceInit(camDevice)) {
        return 
# 272 "./src/main/io/rcdevice_cam.c" 3 4
              0
# 272 "./src/main/io/rcdevice_cam.c"
                   ;
    }
