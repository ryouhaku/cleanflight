...
static 
# 217 "./src/main/io/rcdevice.c" 3 4
      _Bool 
# 217 "./src/main/io/rcdevice.c"
...
static 
# 222 "./src/main/io/rcdevice.c" 3 4
      _Bool 
# 222 "./src/main/io/rcdevice.c"
...
# 233 "./src/main/io/rcdevice.c" 3 4
   _Bool 
# 233 "./src/main/io/rcdevice.c"
    ...
    return 
# 242 "./src/main/io/rcdevice.c" 3 4
          1
# 242 "./src/main/io/rcdevice.c"
              ;
}
...
# 249 "./src/main/io/rcdevice.c" 3 4
_Bool 
# 249 "./src/main/io/rcdevice.c"
    runcamDeviceInit(runcamDevice_t *device)
{
...
# 254 "./src/main/io/rcdevice.c" 3 4
                                                                           ((void *)0)
# 254 "./src/main/io/rcdevice.c"
                                                                               , 115200, MODE_RXTX, SERIAL_NOT_INVERTED);

        if (device->serialPort != 
# 256 "./src/main/io/rcdevice.c" 3 4
                                 ((void *)0)
# 256 "./src/main/io/rcdevice.c"
                                     ) {
            ...
            if (runcamDeviceGetDeviceInfo(device, respBuf)) {
                ...
                return 
# 267 "./src/main/io/rcdevice.c" 3 4
                      1
# 267 "./src/main/io/rcdevice.c"
                          ;
            }
...
# 274 "./src/main/io/rcdevice.c"
                            ;
    return 
# 275 "./src/main/io/rcdevice.c" 3 4
          0
# 275 "./src/main/io/rcdevice.c"
               ;
}


# 278 "./src/main/io/rcdevice.c" 3 4
_Bool 
# 278 "./src/main/io/rcdevice.c"
    runcamDeviceSimulateCameraButton(runcamDevice_t *device, uint8_t operation)
{
...
# 286 "./src/main/io/rcdevice.c" 3 4
_Bool 
# 286 "./src/main/io/rcdevice.c"
    runcamDeviceOpen5KeyOSDCableConnection(runcamDevice_t *device)
{
...
# 296 "./src/main/io/rcdevice.c" 3 4
_Bool 
# 296 "./src/main/io/rcdevice.c"
    runcamDeviceClose5KeyOSDCableConnection(runcamDevice_t *device, uint8_t *resultCode)
{
    uint8_t actionID = 0xFF;
    uint8_t code = 0xFF;
    
# 300 "./src/main/io/rcdevice.c" 3 4
   _Bool 
# 300 "./src/main/io/rcdevice.c"
...
# 308 "./src/main/io/rcdevice.c" 3 4
_Bool 
# 308 "./src/main/io/rcdevice.c"
    runcamDeviceSimulate5KeyOSDCableButtonPress(runcamDevice_t *device, uint8_t operation)
{
    if (operation == RCDEVICE_PROTOCOL_5KEY_SIMULATION_NONE) {
        return 
# 311 "./src/main/io/rcdevice.c" 3 4
              0
# 311 "./src/main/io/rcdevice.c"
                   ;
    }
...
# 314 "./src/main/io/rcdevice.c"
        ...
        return 
# 315 "./src/main/io/rcdevice.c" 3 4
              1
# 315 "./src/main/io/rcdevice.c"
                  ;
    }
...
# 322 "./src/main/io/rcdevice.c" 3 4
_Bool 
# 322 "./src/main/io/rcdevice.c"
    runcamDeviceSimulate5KeyOSDCableButtonRelease(runcamDevice_t *device)
{
    return runcamDeviceSendRequestAndWaitingResp(device, 0x03, 
# 324 "./src/main/io/rcdevice.c" 3 4
                                                                                                           ((void *)0)
# 324 "./src/main/io/rcdevice.c"
                                                                                                               , 0, 
# 324 "./src/main/io/rcdevice.c" 3 4
                                                                                                                    ((void *)0)
# 324 "./src/main/io/rcdevice.c"
...
# 380 "./src/main/io/rcdevice.c" 3 4
                                                   1
# 380 "./src/main/io/rcdevice.c"
                                                       );
}
...
{
    runcamDeviceDispWriteString(device, x, y, text, 
# 385 "./src/main/io/rcdevice.c" 3 4
                                                   0
# 385 "./src/main/io/rcdevice.c"
                                                        );
}
...
static 
# 404 "./src/main/io/rcdevice.c" 3 4
      _Bool 
# 404 "./src/main/io/rcdevice.c"
...
# 407 "./src/main/io/rcdevice.c"
    ...
    if (RCDP_SETTING_PARSE_WAITING_ID != parseStep) {
        return 
# 452 "./src/main/io/rcdevice.c" 3 4
              0
# 452 "./src/main/io/rcdevice.c"
                   ;
    }

    return 
# 455 "./src/main/io/rcdevice.c" 3 4
          1
# 455 "./src/main/io/rcdevice.c"
              ;
}

static 
# 458 "./src/main/io/rcdevice.c" 3 4
      _Bool 
# 458 "./src/main/io/rcdevice.c"
...
{
    if (responseData == 
# 460 "./src/main/io/rcdevice.c" 3 4
                       ((void *)0) 
# 460 "./src/main/io/rcdevice.c"
                            || responseDatalen == 
# 460 "./src/main/io/rcdevice.c" 3 4
                                                  ((void *)0)
# 460 "./src/main/io/rcdevice.c"
        ...
        return 
# 461 "./src/main/io/rcdevice.c" 3 4
              0
# 461 "./src/main/io/rcdevice.c"
                   ;
    }
...
# 472 "./src/main/io/rcdevice.c"
    ...
    if (!result) {
        return 
# 474 "./src/main/io/rcdevice.c" 3 4
              0
# 474 "./src/main/io/rcdevice.c"
                   ;
    }
    ...
    if (remainingChunk >= 12) {
        return 
# 480 "./src/main/io/rcdevice.c" 3 4
              0
# 480 "./src/main/io/rcdevice.c"
                   ;
    }
...
# 518 "./src/main/io/rcdevice.c" 3 4
_Bool 
# 518 "./src/main/io/rcdevice.c"
    runcamDeviceGetSettings(runcamDevice_t *device, uint8_t parentSettingID, runcamDeviceSetting_t *outSettingList, int maxSettingItemCount)
{
    if (outSettingList == 
...
# 520 "./src/main/io/rcdevice.c"
        ...
        return 
# 521 "./src/main/io/rcdevice.c" 3 4
              0
# 521 "./src/main/io/rcdevice.c"
                   ;
    }
    ...
    if (!runcamDeviceGetResponseWithMultipleChunk(device, 0x10, parentSettingID, data, &responseDataLength)) {
        return 
# 527 "./src/main/io/rcdevice.c" 3 4
              0
# 527 "./src/main/io/rcdevice.c"
                   ;
    }
    ...
    if (!runcamDeviceDecodeSettings(&dataBuf, outSettingList, maxSettingItemCount)) {
        return 
# 536 "./src/main/io/rcdevice.c" 3 4
              0
# 536 "./src/main/io/rcdevice.c"
                   ;
    }
...
static 
# 542 "./src/main/io/rcdevice.c" 3 4
      _Bool 
# 542 "./src/main/io/rcdevice.c"
...
# 544 "./src/main/io/rcdevice.c"
        ...
        return 
# 545 "./src/main/io/rcdevice.c" 3 4
              0
# 545 "./src/main/io/rcdevice.c"
                   ;
    }
...
# 584 "./src/main/io/rcdevice.c"
            ...
            iterator++;
            result = strtok(
# 592 "./src/main/io/rcdevice.c" 3 4
                           ((void *)0)
# 592 "./src/main/io/rcdevice.c"
                               , delims);
            i++;
        }
    }
    ...
    return 
# 617 "./src/main/io/rcdevice.c" 3 4
          1
# 617 "./src/main/io/rcdevice.c"
              ;
}
...
# 623 "./src/main/io/rcdevice.c" 3 4
_Bool 
# 623 "./src/main/io/rcdevice.c"
    runcamDeviceGetSettingDetail(runcamDevice_t *device, uint8_t settingID, runcamDeviceSettingDetail_t *outSettingDetail)
{
    if (outSettingDetail == 
# 625 "./src/main/io/rcdevice.c" 3 4
                           ((void *)0)
# 625 "./src/main/io/rcdevice.c"
                               )
        return 
# 626 "./src/main/io/rcdevice.c" 3 4
              0
# 626 "./src/main/io/rcdevice.c"
                   ;
...
# 631 "./src/main/io/rcdevice.c"
    ...
    if (!runcamDeviceDecodeSettingDetail(&dataBuf, outSettingDetail)) {
        return 
# 640 "./src/main/io/rcdevice.c" 3 4
              0
# 640 "./src/main/io/rcdevice.c"
                   ;
    }

    return 
# 643 "./src/main/io/rcdevice.c" 3 4
          1
# 643 "./src/main/io/rcdevice.c"
              ;
}



# 647 "./src/main/io/rcdevice.c" 3 4
_Bool 
# 647 "./src/main/io/rcdevice.c"
...
{
    if (response == 
# 649 "./src/main/io/rcdevice.c" 3 4
                   ((void *)0) 
# 649 "./src/main/io/rcdevice.c"
                        || paramDataLen > (62 - 1)) {
        return 
# 650 "./src/main/io/rcdevice.c" 3 4
              0
# 650 "./src/main/io/rcdevice.c"
                   ;
    }
...
# 663 "./src/main/io/rcdevice.c" 3 4
   _Bool 
# 663 "./src/main/io/rcdevice.c"
        result = runcamDeviceSendRequestAndWaitingResp(device, 0x13, paramsBuf, paramsBufLen, outputBuf, &outputBufLen);
    if (!result) {
        return 
# 665 "./src/main/io/rcdevice.c" 3 4
              0
# 665 "./src/main/io/rcdevice.c"
                   ;
    }
    ...
    return 
# 671 "./src/main/io/rcdevice.c" 3 4
          1
# 671 "./src/main/io/rcdevice.c"
              ;
}
