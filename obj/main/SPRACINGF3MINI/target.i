# 1 "./src/main/target/SPRACINGF3MINI/target.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/target/SPRACINGF3MINI/target.c"
# 18 "./src/main/target/SPRACINGF3MINI/target.c"
...
# 19 "./src/main/target/SPRACINGF3MINI/target.c" 2
...
# 21 "./src/main/target/SPRACINGF3MINI/target.c" 2
...
# 22 "./src/main/target/SPRACINGF3MINI/target.c" 2
...
# 24 "./src/main/target/SPRACINGF3MINI/target.c" 2
# 1 "./src/main/drivers/timer_def.h" 1
# 19 "./src/main/drivers/timer_def.h"
       
# 25 "./src/main/target/SPRACINGF3MINI/target.c" 2
...
# 26 "./src/main/target/SPRACINGF3MINI/target.c" 2

const timerHardware_t timerHardware[12] = {
# 47 "./src/main/target/SPRACINGF3MINI/target.c"
    { ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00000400)), ((ioTag_t)((((1) + 1) << 4) | (4))), ((uint16_t)0x0000), TIM_USE_PPM, (TIMER_OUTPUT_NONE | 0), ((uint8_t)0x02), ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000006C)), DMA1_CH6_HANDLER },
    ...
    { ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00004800)), ((ioTag_t)((((0) + 1) << 4) | (7))), ((uint16_t)0x0000), TIM_USE_MOTOR, (TIMER_OUTPUT_NONE | 1), ((uint8_t)0x01), ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000008)), DMA1_CH1_HANDLER },
...
# 54 "./src/main/target/SPRACINGF3MINI/target.c" 3 4
   ((void *)0)
# 54 "./src/main/target/SPRACINGF3MINI/target.c"
   , 0 },
...
# 56 "./src/main/target/SPRACINGF3MINI/target.c" 3 4
   ((void *)0)
# 56 "./src/main/target/SPRACINGF3MINI/target.c"
   , 0 },
    { ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00000000)), ((ioTag_t)((((0) + 1) << 4) | (0))), ((uint16_t)0x0000), TIM_USE_MOTOR, (TIMER_OUTPUT_NONE | 1), ((uint8_t)0x01), ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000058)), DMA1_CH5_HANDLER },
    { ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00000000)), ((ioTag_t)((((0) + 1) << 4) | (1))), ((uint16_t)0x0004), TIM_USE_MOTOR, (TIMER_OUTPUT_NONE | 1), ((uint8_t)0x01), ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000080)), DMA1_CH7_HANDLER },
    { ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00000000)), ((ioTag_t)((((1) + 1) << 4) | (10))), ((uint16_t)0x0008), TIM_USE_NONE, (TIMER_OUTPUT_NONE | 1), ((uint8_t)0x01), ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000008)), DMA1_CH1_HANDLER },
    { ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00000000)), ((ioTag_t)((((1) + 1) << 4) | (11))), ((uint16_t)0x000C), TIM_USE_NONE, (TIMER_OUTPUT_NONE | 1), ((uint8_t)0x01), ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000080)), DMA1_CH7_HANDLER },

    { ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00002C00)), ((ioTag_t)((((0) + 1) << 4) | (8))), ((uint16_t)0x0000), TIM_USE_LED | TIM_USE_TRANSPONDER, (TIMER_OUTPUT_NONE | 1), ((uint8_t)0x06), ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000001C)), DMA1_CH2_HANDLER },
};
