...
# 134 "./src/main/cms/cms.c"

# 134 "./src/main/cms/cms.c" 3 4
_Bool 
# 134 "./src/main/cms/cms.c"
    cmsInMenu = 
# 134 "./src/main/cms/cms.c" 3 4
...
static int cmsDrawMenuEntry(displayPort_t *pDisplay, OSD_Entry *p, uint8_t row)
{
    ...
    case OME_TAB:
        if (((p)->flags & 0x01)) {
            ...
            memcpy(buff, str, __extension__ ({ __typeof__ (10u) _a = (10u); __typeof__ (strlen(str)) _b = (strlen(str)); _a > _b ? _a : _b; }));
            cmsPadToSize(buff, 10u);
            cnt = displayWrite(pDisplay, ((pDisplay)->cols - 8), row, buff);
            { (p)->flags &= ~0x01; };
        }
        break;
# 335 "./src/main/cms/cms.c"
    case OME_UINT8:
        if (((p)->flags & 0x01) && p->data) {
    ...
    case OME_Label:
        if (((p)->flags & 0x01) && p->data) {
            ...
            cnt = displayWrite(pDisplay, 1 + 2 + strlen(p->text), row, p->data);
            { (p)->flags &= ~0x01; };
        }
        break;
...
# 422 "./src/main/cms/cms.c" 3 4
   _Bool 
# 422 "./src/main/cms/cms.c"
        drawPolled = 
# 422 "./src/main/cms/cms.c" 3 4
                     0
# 422 "./src/main/cms/cms.c"
    ...
    if (currentTimeUs > lastPolledUs + 100000) {
        drawPolled = 
# 426 "./src/main/cms/cms.c" 3 4
                    1
# 426 "./src/main/cms/cms.c"
                        ;
    ...
    if (pDisplay->cleared) {
        ...
        pDisplay->cleared = 
# 437 "./src/main/cms/cms.c" 3 4
                           0
# 437 "./src/main/cms/cms.c"
                                ;
    } else if (drawPolled) {
...
static void cmsMenuOpen(void)
{
    if (!cmsInMenu) {
        ...
        if (!pCurrentDisplay)
            return;
        cmsInMenu = 
# 580 "./src/main/cms/cms.c" 3 4
                   1
# 580 "./src/main/cms/cms.c"
                       ;
...
# 623 "./src/main/cms/cms.c" 3 4
                                                ((void *)0)
# 623 "./src/main/cms/cms.c"
                                                    );
    ...
    cmsInMenu = 
# 632 "./src/main/cms/cms.c" 3 4
               0
# 632 "./src/main/cms/cms.c"
                    ;

    displayRelease(pDisplay);
    currentCtx.menu = 
# 635 "./src/main/cms/cms.c" 3 4
                     ((void *)0)
# 635 "./src/main/cms/cms.c"
                         ;
