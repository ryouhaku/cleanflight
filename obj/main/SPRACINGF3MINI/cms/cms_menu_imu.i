...
# 31 "./src/main/cms/cms_menu_imu.c" 2
...
static OSD_Entry cmsx_menuProfileOtherEntries[] = {
    { "-- OTHER PP --", OME_Label, 
# 279 "./src/main/cms/cms_menu_imu.c" 3 4
                                  ((void *)0)
# 279 "./src/main/cms/cms_menu_imu.c"
                                      , pidProfileIndexString, 0 },
...
# 281 "./src/main/cms/cms_menu_imu.c"
    ...
    { "SETPT TRS", OME_FLOAT, 
# 282 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 282 "./src/main/cms/cms_menu_imu.c"
...
# 283 "./src/main/cms/cms_menu_imu.c"
    ...
    { "HORZN STR", OME_UINT8, 
# 284 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 284 "./src/main/cms/cms_menu_imu.c"
...
static CMS_Menu cmsx_menuFilterGlobal = {
    ...
    .onGlobalExit = 
# 351 "./src/main/cms/cms_menu_imu.c" 3 4
                   ((void *)0)
# 351 "./src/main/cms/cms_menu_imu.c"
                       ,
...
{
    { "-- FILTER PP  --", OME_Label, 
# 386 "./src/main/cms/cms_menu_imu.c" 3 4
                                    ((void *)0)
# 386 "./src/main/cms/cms_menu_imu.c"
                                        , 
# 386 "./src/main/cms/cms_menu_imu.c" 3 4
                                          ((void *)0)
# 386 "./src/main/cms/cms_menu_imu.c"
...
# 388 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 388 "./src/main/cms/cms_menu_imu.c"
...
# 390 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 390 "./src/main/cms/cms_menu_imu.c"
...
# 455 "./src/main/cms/cms_menu_imu.c" 3 4
                                      ((void *)0)
# 455 "./src/main/cms/cms_menu_imu.c"
                                          , 
# 455 "./src/main/cms/cms_menu_imu.c" 3 4
                                            ((void *)0)
# 455 "./src/main/cms/cms_menu_imu.c"
...
# 459 "./src/main/cms/cms_menu_imu.c" 3 4
                                        ((void *)0)
# 459 "./src/main/cms/cms_menu_imu.c"
                                            , &cmsx_ControlRateProfileTable, 0 },
    { "COPY RP", OME_Funcall, cmsx_CopyControlRateProfile, 
# 460 "./src/main/cms/cms_menu_imu.c" 3 4
                                                                     ((void *)0)
# 460 "./src/main/cms/cms_menu_imu.c"
                                                                         , 0 },
...
# 462 "./src/main/cms/cms_menu_imu.c"
                                 , 0 },
    { 
# 463 "./src/main/cms/cms_menu_imu.c" 3 4
     ((void *)0)
# 463 "./src/main/cms/cms_menu_imu.c"
         , OME_END, 
# 463 "./src/main/cms/cms_menu_imu.c" 3 4
                    ((void *)0)
# 463 "./src/main/cms/cms_menu_imu.c"
