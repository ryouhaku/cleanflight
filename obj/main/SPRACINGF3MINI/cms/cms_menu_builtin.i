...
static char infoGitRev[7];
static char infoTargetName[] = "SPRACINGF3MINI";
...
static OSD_Entry menuInfoEntries[] = {
    { "--- INFO ---", OME_Label, 
# 74 "./src/main/cms/cms_menu_builtin.c" 3 4
                                ((void *)0)
# 74 "./src/main/cms/cms_menu_builtin.c"
                                    , 
# 74 "./src/main/cms/cms_menu_builtin.c" 3 4
                                      ((void *)0)
# 74 "./src/main/cms/cms_menu_builtin.c"
                                          , 0 },
    { "FWID", OME_String, 
# 75 "./src/main/cms/cms_menu_builtin.c" 3 4
                         ((void *)0)
# 75 "./src/main/cms/cms_menu_builtin.c"
                             , "CLFL", 0 },
    { "FWVER", OME_String, 
...
{
    {"--- FEATURES ---", OME_Label, 
# 96 "./src/main/cms/cms_menu_builtin.c" 3 4
                                   ((void *)0)
# 96 "./src/main/cms/cms_menu_builtin.c"
                                       , 
# 96 "./src/main/cms/cms_menu_builtin.c" 3 4
                                         ((void *)0)
# 96 "./src/main/cms/cms_menu_builtin.c"
    ...
    {"BACK", OME_Back, 
# 115 "./src/main/cms/cms_menu_builtin.c" 3 4
                      ((void *)0)
# 115 "./src/main/cms/cms_menu_builtin.c"
                          , 
# 115 "./src/main/cms/cms_menu_builtin.c" 3 4
                            ((void *)0)
# 115 "./src/main/cms/cms_menu_builtin.c"
                                , 0},
    {
# 116 "./src/main/cms/cms_menu_builtin.c" 3 4
    ((void *)0)
# 116 "./src/main/cms/cms_menu_builtin.c"
        , OME_END, 
# 116 "./src/main/cms/cms_menu_builtin.c" 3 4
                   ((void *)0)
# 116 "./src/main/cms/cms_menu_builtin.c"
...
static CMS_Menu menuFeatures = {
    ...
    .GUARD_type = OME_MENU,
    .onEnter = 
# 122 "./src/main/cms/cms_menu_builtin.c" 3 4
              ((void *)0)
# 122 "./src/main/cms/cms_menu_builtin.c"
                  ,
    .onExit = 
...
# 155 "./src/main/cms/cms_menu_builtin.c"
                 ,
    .onGlobalExit = 
# 156 "./src/main/cms/cms_menu_builtin.c" 3 4
                   ((void *)0)
# 156 "./src/main/cms/cms_menu_builtin.c"
                       ,
