...
# 27 "./src/main/cms/cms_menu_vtx_rtc6705.c" 2
...
# 28 "./src/main/cms/cms_menu_vtx_rtc6705.c" 2
...
# 30 "./src/main/cms/cms_menu_vtx_rtc6705.c" 2
...
# 33 "./src/main/cms/cms_menu_vtx_rtc6705.c" 2
...
# 35 "./src/main/cms/cms_menu_vtx_rtc6705.c" 2
...
static OSD_TAB_t entryVtxBand = {&cmsx_vtxBand, (sizeof(rtc6705BandNames) / sizeof((rtc6705BandNames)[0])) - 1, &rtc6705BandNames[0]};
static OSD_UINT8_t entryVtxChannel = {&cmsx_vtxChannel, 1, (8 - 1 + 1), 1};
static OSD_TAB_t entryVtxPower = {&cmsx_vtxPower, 3 - 1 - 1, &rtc6705PowerNames[1]};

static void cmsx_Vtx_ConfigRead(void)
{
    cmsx_vtxBand = vtxSettingsConfig()->band - 1;
    cmsx_vtxChannel = vtxSettingsConfig()->channel;
    cmsx_vtxPower = vtxSettingsConfig()->power - 1;
}

static void cmsx_Vtx_ConfigWriteback(void)
{
    vtxSettingsSaveBandChanAndPower(cmsx_vtxBand + 1, cmsx_vtxChannel, cmsx_vtxPower + 1);
}
...
{
    {"--- VTX ---", OME_Label, 
# 84 "./src/main/cms/cms_menu_vtx_rtc6705.c" 3 4
                              ((void *)0)
# 84 "./src/main/cms/cms_menu_vtx_rtc6705.c"
                                  , 
# 84 "./src/main/cms/cms_menu_vtx_rtc6705.c" 3 4
                                    ((void *)0)
# 84 "./src/main/cms/cms_menu_vtx_rtc6705.c"
                                        , 0},
    {"BAND", OME_TAB, 
# 85 "./src/main/cms/cms_menu_vtx_rtc6705.c" 3 4
                     ((void *)0)
# 85 "./src/main/cms/cms_menu_vtx_rtc6705.c"
                         , &entryVtxBand, 0},
    {"CHANNEL", OME_UINT8, 
# 86 "./src/main/cms/cms_menu_vtx_rtc6705.c" 3 4
                          ((void *)0)
# 86 "./src/main/cms/cms_menu_vtx_rtc6705.c"
                              , &entryVtxChannel, 0},
    {"POWER", OME_TAB, 
# 87 "./src/main/cms/cms_menu_vtx_rtc6705.c" 3 4
                      ((void *)0)
# 87 "./src/main/cms/cms_menu_vtx_rtc6705.c"
                          , &entryVtxPower, 0},
    {"BACK", OME_Back, 
# 88 "./src/main/cms/cms_menu_vtx_rtc6705.c" 3 4
                      ((void *)0)
# 88 "./src/main/cms/cms_menu_vtx_rtc6705.c"
                          , 
# 88 "./src/main/cms/cms_menu_vtx_rtc6705.c" 3 4
                            ((void *)0)
# 88 "./src/main/cms/cms_menu_vtx_rtc6705.c"
                                , 0},
    {
# 89 "./src/main/cms/cms_menu_vtx_rtc6705.c" 3 4
    ((void *)0)
# 89 "./src/main/cms/cms_menu_vtx_rtc6705.c"
        , OME_END, 
# 89 "./src/main/cms/cms_menu_vtx_rtc6705.c" 3 4
                   ((void *)0)
# 89 "./src/main/cms/cms_menu_vtx_rtc6705.c"
...
CMS_Menu cmsx_menuVtxRTC6705 = {
    ...
    .onGlobalExit = 
# 97 "./src/main/cms/cms_menu_vtx_rtc6705.c" 3 4
                   ((void *)0)
# 97 "./src/main/cms/cms_menu_vtx_rtc6705.c"
                       ,
