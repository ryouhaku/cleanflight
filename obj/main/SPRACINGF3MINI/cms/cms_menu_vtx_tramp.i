...
# 28 "./src/main/cms/cms_menu_vtx_tramp.c" 2
...
static OSD_Entry trampCmsMenuCommenceEntries[] = {
    { "CONFIRM", OME_Label, 
# 187 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                             ((void *)0)
# 187 "./src/main/cms/cms_menu_vtx_tramp.c"
                                 , 
# 187 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                                            ((void *)0)
# 187 "./src/main/cms/cms_menu_vtx_tramp.c"
...
# 188 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                                               ((void *)0)
# 188 "./src/main/cms/cms_menu_vtx_tramp.c"
                                                   , 0 },
    { "BACK", OME_Back, 
# 189 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                          ((void *)0)
# 189 "./src/main/cms/cms_menu_vtx_tramp.c"
                              , 
# 189 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                                ((void *)0)
# 189 "./src/main/cms/cms_menu_vtx_tramp.c"
                                    , 0 },
    { 
# 190 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
     ((void *)0)
# 190 "./src/main/cms/cms_menu_vtx_tramp.c"
         , OME_END, 
# 190 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                         ((void *)0)
# 190 "./src/main/cms/cms_menu_vtx_tramp.c"
...
{
    { "- TRAMP -", OME_Label, 
# 204 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                             ((void *)0)
# 204 "./src/main/cms/cms_menu_vtx_tramp.c"
                                 , 
# 204 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                                   ((void *)0)
# 204 "./src/main/cms/cms_menu_vtx_tramp.c"
