...
const char * const targetName = "SPRACINGF3MINI";
const char * const shortGitRevision = "bba1f59f9";
const char * const buildDate = "Feb  1 2018";
const char * const buildTime = "13:39:44";
