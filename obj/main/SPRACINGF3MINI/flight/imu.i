...
# 23 "./src/main/sensors/compass.h" 2
...
# 412 "./src/main/flight/imu.c" 3 4
   _Bool 
# 412 "./src/main/flight/imu.c"
        useAcc = 
# 412 "./src/main/flight/imu.c" 3 4
                 0
# 412 "./src/main/flight/imu.c"
...
# 413 "./src/main/flight/imu.c" 3 4
   _Bool 
# 413 "./src/main/flight/imu.c"
        useMag = 
# 413 "./src/main/flight/imu.c" 3 4
                 0
# 413 "./src/main/flight/imu.c"
...
# 414 "./src/main/flight/imu.c" 3 4
   _Bool 
# 414 "./src/main/flight/imu.c"
        useYaw = 
# 414 "./src/main/flight/imu.c" 3 4
                 0
# 414 "./src/main/flight/imu.c"
    ...
    if (imuIsAccelerometerHealthy()) {
        useAcc = 
# 420 "./src/main/flight/imu.c" 3 4
                1
# 420 "./src/main/flight/imu.c"
                    ;
    }
...
# 447 "./src/main/flight/imu.c"
    imuMahonyAHRSupdate(deltaT * 1e-6f,
                        ((gyro.gyroADCf[X]) * 0.0174532925f), ((gyro.gyroADCf[Y]) * 0.0174532925f), ((gyro.gyroADCf[Z]) * 0.0174532925f),
...
# 550 "./src/main/flight/imu.c" 3 4
_Bool 
# 550 "./src/main/flight/imu.c"
    imuQuaternionHeadfreeOffsetSet(void) {
    if ((__extension__ ({ __typeof__ (attitude.values.roll) _x = (attitude.values.roll); _x > 0 ? _x : -_x; }) < 450) && (__extension__ ({ __typeof__ (attitude.values.pitch) _x = (attitude.values.pitch); _x > 0 ? _x : -_x; }) < 450)) {
        ...
        return(
# 559 "./src/main/flight/imu.c" 3 4
              1
# 559 "./src/main/flight/imu.c"
                  );
    } else {
        return(
