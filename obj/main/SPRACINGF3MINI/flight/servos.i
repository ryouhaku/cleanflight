...
void pgResetFn_servoConfig(servoConfig_t *servoConfig)
{
    ...
    int servoIndex = 0;
    for (int i = 0; i < 12 && servoIndex < 8; i++) {
...
# 198 "./src/main/flight/servos.c"
    ...
    { 0, 
# 199 "./src/main/flight/servos.c" 3 4
        ((void *)0) 
# 199 "./src/main/flight/servos.c"
             },
};
...
static void servoTable(void)
{
    ...
    case MIXER_RX_TO_SERVO:
        for (int i = 0; i < __extension__ ({ __typeof__ (8) _a = (8); __typeof__ (18) _b = (18); _a < _b ? _a : _b; }); i++) {
            servo[i] = rcData[i];
        }
        break;
# 502 "./src/main/flight/servos.c"
    default:
        break;
    }
...
# 529 "./src/main/flight/servos.c" 3 4
_Bool 
# 529 "./src/main/flight/servos.c"
    isMixerUsingServos(void)
{
    return useServo;
}
