...
# 153 "./src/main/flight/pid.c" 3 4
                                                                            1 
# 153 "./src/main/flight/pid.c"
                                                                                 : 
# 153 "./src/main/flight/pid.c" 3 4
                                                                                   0
# 153 "./src/main/flight/pid.c"
...
# 529 "./src/main/flight/pid.c"
                                                  ;
                        systemBeep(
# 530 "./src/main/flight/pid.c" 3 4
                       0
# 530 "./src/main/flight/pid.c"
                       );
                    }
                } else if (inCrashRecoveryMode) {
                    inCrashRecoveryMode = 
# 533 "./src/main/flight/pid.c" 3 4
                                         0
# 533 "./src/main/flight/pid.c"
                                              ;
                    systemBeep(
# 534 "./src/main/flight/pid.c" 3 4
                   0
# 534 "./src/main/flight/pid.c"
                   );
                }
            }
...
# 549 "./src/main/flight/pid.c" 3 4
_Bool 
# 549 "./src/main/flight/pid.c"
    crashRecoveryModeActive(void)
{
