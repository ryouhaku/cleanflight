...
# 83 "./src/main/flight/mixer.c" 3 4
                                         1
# 83 "./src/main/flight/mixer.c"
                                             ;
    } else
    ...
    int motorIndex = 0;
    for (int i = 0; i < 12 && motorIndex < 8; i++) {
...
# 326 "./src/main/flight/mixer.c" 3 4
_Bool 
...
# 330 "./src/main/flight/mixer.c"
        ...
        for (int i = 0; i < motorCount; i++) {
            if (motor_disarmed[i] != disarmMotorOutput) {
                motorsRunning = 
# 334 "./src/main/flight/mixer.c" 3 4
                               1
# 334 "./src/main/flight/mixer.c"
                                   ;
...
# 344 "./src/main/flight/mixer.c" 3 4
_Bool 
# 344 "./src/main/flight/mixer.c"
    mixerIsOutputSaturated(int axis, float errorRate)
{
    ...
    return 
# 351 "./src/main/flight/mixer.c" 3 4
          0
# 351 "./src/main/flight/mixer.c"
               ;
}
...
# 460 "./src/main/flight/mixer.c" 3 4
                              ((void *)0)
# 460 "./src/main/flight/mixer.c"
                                  ) {
...
void mixTable(uint8_t vbatPidCompensation)
{
    ...
    float scaledAxisPidRoll =
        constrainf(axisPID_P[FD_ROLL] + axisPID_I[FD_ROLL] + axisPID_D[FD_ROLL], -currentPidProfile->pidSumLimit, currentPidProfile->pidSumLimit) / 1000.0f;
    float scaledAxisPidPitch =
        constrainf(axisPID_P[FD_PITCH] + axisPID_I[FD_PITCH] + axisPID_D[FD_PITCH], -currentPidProfile->pidSumLimit, currentPidProfile->pidSumLimit) / 1000.0f;
    float scaledAxisPidYaw =
        constrainf(axisPID_P[FD_YAW] + axisPID_I[FD_YAW], -currentPidProfile->pidSumLimitYaw, currentPidProfile->pidSumLimitYaw) / 1000.0f;
...
float convertExternalToMotor(uint16_t externalValue)
{
    ...
    case 
# 733 "./src/main/flight/mixer.c" 3 4
        1
# 733 "./src/main/flight/mixer.c"
            :
        ...
        break;
    case 
# 749 "./src/main/flight/mixer.c" 3 4
        0
# 749 "./src/main/flight/mixer.c"
             :
...
uint16_t convertMotorToExternal(float motorValue)
{
    ...
    case 
# 765 "./src/main/flight/mixer.c" 3 4
        1
# 765 "./src/main/flight/mixer.c"
            :
        if (feature(FEATURE_3D)) {
        ...
        break;
    case 
# 779 "./src/main/flight/mixer.c" 3 4
        0
# 779 "./src/main/flight/mixer.c"
             :
