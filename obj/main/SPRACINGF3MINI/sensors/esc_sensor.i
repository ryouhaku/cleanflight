...
# 195 "./src/main/sensors/esc_sensor.c" 3 4
_Bool 
# 195 "./src/main/sensors/esc_sensor.c"
    escSensorInit(void)
{
    serialPortConfig_t *portConfig = findSerialPortConfig(FUNCTION_ESC_SENSOR);
    if (!portConfig) {
        return 
# 199 "./src/main/sensors/esc_sensor.c" 3 4
              0
# 199 "./src/main/sensors/esc_sensor.c"
                   ;
    }
    ...
    escSensorPort = openSerialPort(portConfig->identifier, FUNCTION_ESC_SENSOR, escSensorDataReceive, 115200, MODE_RX, options);
    ...
    return escSensorPort != 
# 211 "./src/main/sensors/esc_sensor.c" 3 4
                           ((void *)0)
# 211 "./src/main/sensors/esc_sensor.c"
                               ;
}
...
static uint8_t decodeEscFrame(void)
{
    ...
    if (chksum == tlmsum) {
        ...
        combinedDataNeedsUpdate = 
# 254 "./src/main/sensors/esc_sensor.c" 3 4
                                 1
# 254 "./src/main/sensors/esc_sensor.c"
                                     ;
...
static void increaseDataAge(void)
{
    if (escSensorData[escSensorMotor].dataAge < 255) {
        ...
        combinedDataNeedsUpdate = 
# 272 "./src/main/sensors/esc_sensor.c" 3 4
                                 1
# 272 "./src/main/sensors/esc_sensor.c"
                                     ;
    }
}
...
# 305 "./src/main/sensors/esc_sensor.c" 3 4
                                     1
# 305 "./src/main/sensors/esc_sensor.c"
                                         ;
