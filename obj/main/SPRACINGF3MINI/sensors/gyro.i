...
# 87 "./src/main/sensors/gyro.c" 3 4
_Bool 
# 87 "./src/main/sensors/gyro.c"
...
# 128 "./src/main/sensors/gyro.c" 3 4
0
# 128 "./src/main/sensors/gyro.c"
, .gyro_use_32khz = 
# 128 "./src/main/sensors/gyro.c" 3 4
0
# 128 "./src/main/sensors/gyro.c"
, .gyro_to_use = 0, .gyro_soft_notch_hz_1 = 400, .gyro_soft_notch_cutoff_1 = 300, .gyro_soft_notch_hz_2 = 200, .gyro_soft_notch_cutoff_2 = 100 }
...
static 
# 322 "./src/main/sensors/gyro.c" 3 4
      _Bool 
# 322 "./src/main/sensors/gyro.c"
...
# 339 "./src/main/sensors/gyro.c"
    ...
    if (gyroHardware == GYRO_NONE) {
        return 
# 348 "./src/main/sensors/gyro.c" 3 4
              0
# 348 "./src/main/sensors/gyro.c"
                   ;
    }
...
# 362 "./src/main/sensors/gyro.c"
    ...
    return 
# 378 "./src/main/sensors/gyro.c" 3 4
          1
# 378 "./src/main/sensors/gyro.c"
              ;
}


# 381 "./src/main/sensors/gyro.c" 3 4
_Bool 
# 381 "./src/main/sensors/gyro.c"
    gyroInit(void)
{
    switch (debugMode) {
    case DEBUG_FFT:
...
# 523 "./src/main/sensors/gyro.c" 3 4
_Bool 
# 523 "./src/main/sensors/gyro.c"
    isGyroCalibrationComplete(void)
{
...
static 
# 528 "./src/main/sensors/gyro.c" 3 4
      _Bool 
# 528 "./src/main/sensors/gyro.c"
...
{
    return (1000 / gyro.targetLooptime) * 1000;
}

static 
# 538 "./src/main/sensors/gyro.c" 3 4
      _Bool 
# 538 "./src/main/sensors/gyro.c"
                              ...
                              isFirstArmingCalibration)
{
    if (!(isFirstArmingCalibration && firstArmingCalibrationWasStarted)) {
        ...
        if (isFirstArmingCalibration) {
            firstArmingCalibrationWasStarted = 
# 554 "./src/main/sensors/gyro.c" 3 4
                                              1
# 554 "./src/main/sensors/gyro.c"
                                                  ;
        }
    }
}
...
# 559 "./src/main/sensors/gyro.c" 3 4
_Bool 
# 559 "./src/main/sensors/gyro.c"
    isFirstArmingGyroCalibrationRunning(void)
{
...
# 621 "./src/main/sensors/gyro.c" 3 4
                                   0
# 621 "./src/main/sensors/gyro.c"
                                        ;
