...
void processRcStickPositions(throttleStatus_e throttleStatus)
{
    ...
    static 
# 142 "./src/main/fc/rc_controls.c" 3 4
          _Bool 
# 142 "./src/main/fc/rc_controls.c"
               doNotRepeat;
    ...
    if (stTmp == rcSticks) {
        if (rcDelayMs <= 
# 162 "./src/main/fc/rc_controls.c" 3 4
                        (0x7fff) 
# 162 "./src/main/fc/rc_controls.c"
        ...
        rcDelayMs = 0;
        doNotRepeat = 
# 167 "./src/main/fc/rc_controls.c" 3 4
                     0
# 167 "./src/main/fc/rc_controls.c"
                          ;
    }
    rcSticks = stTmp;
...
# 199 "./src/main/fc/rc_controls.c" 3 4
               0
# 199 "./src/main/fc/rc_controls.c"
               ; };
            }
        }
        return;
        ...
        if (rcDelayMs >= 500 && !doNotRepeat) {
            doNotRepeat = 
# 205 "./src/main/fc/rc_controls.c" 3 4
                         1
# 205 "./src/main/fc/rc_controls.c"
                             ;
            if (!(armingFlags & (ARMED))) {
    ...
    doNotRepeat = 
# 219 "./src/main/fc/rc_controls.c" 3 4
                 1
# 219 "./src/main/fc/rc_controls.c"
                     ;
...
# 225 "./src/main/fc/rc_controls.c" 3 4
                            0
# 225 "./src/main/fc/rc_controls.c"
                                 );
...
# 283 "./src/main/fc/rc_controls.c" 3 4
   _Bool 
# 283 "./src/main/fc/rc_controls.c"
...
# 283 "./src/main/fc/rc_controls.c"
    ...
    if (rcSticks == (2 << (2 * THROTTLE)) + (3 << (2 * YAW)) + (2 << (2 * PITCH)) + (3 << (2 * ROLL))) {
        ...
        shouldApplyRollAndPitchTrimDelta = 
# 286 "./src/main/fc/rc_controls.c" 3 4
                                          1
# 286 "./src/main/fc/rc_controls.c"
                                              ;
    } else if (rcSticks == (2 << (2 * THROTTLE)) + (3 << (2 * YAW)) + (1 << (2 * PITCH)) + (3 << (2 * ROLL))) {
        accelerometerTrimsDelta.values.pitch = -2;
        shouldApplyRollAndPitchTrimDelta = 
# 289 "./src/main/fc/rc_controls.c" 3 4
                                          1
# 289 "./src/main/fc/rc_controls.c"
                                              ;
...
# 292 "./src/main/fc/rc_controls.c"
        ...
        accelerometerTrimsDelta.values.roll = -2;
        shouldApplyRollAndPitchTrimDelta = 
# 295 "./src/main/fc/rc_controls.c" 3 4
                                          1
# 295 "./src/main/fc/rc_controls.c"
                                              ;
    }
    if (shouldApplyRollAndPitchTrimDelta) {
        applyAndSaveAccelerometerTrimsDelta(&accelerometerTrimsDelta);
        { rcDelayMs -= (250); doNotRepeat = 
# 299 "./src/main/fc/rc_controls.c" 3 4
       0
# 299 "./src/main/fc/rc_controls.c"
       ; };
        return;
    }
...
# 331 "./src/main/fc/rc_controls.c" 3 4
       0
# 331 "./src/main/fc/rc_controls.c"
       ; };
...
# 334 "./src/main/fc/rc_controls.c"
       ; };
        ...
        { rcDelayMs -= (3 * 50); doNotRepeat = 
# 337 "./src/main/fc/rc_controls.c" 3 4
       0
# 337 "./src/main/fc/rc_controls.c"
       ; };
        ...
        { rcDelayMs -= (3 * 50); doNotRepeat = 
# 340 "./src/main/fc/rc_controls.c" 3 4
       0
# 340 "./src/main/fc/rc_controls.c"
       ; };
