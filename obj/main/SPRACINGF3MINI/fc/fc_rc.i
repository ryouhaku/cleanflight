...
static 
# 52 "./src/main/fc/fc_rc.c" 3 4
      _Bool 
# 52 "./src/main/fc/fc_rc.c"
           reverseMotors = 
# 52 "./src/main/fc/fc_rc.c" 3 4
                           0
# 52 "./src/main/fc/fc_rc.c"
...
# 199 "./src/main/fc/fc_rc.c" 3 4
   _Bool 
# 199 "./src/main/fc/fc_rc.c"
...
# 199 "./src/main/fc/fc_rc.c"
    ...
    if (rxConfig()->rcInterpolation) {
        ...
        if (rcInterpolationStepCount > 0) {
            ...
            readyToCalculateRate = 
# 241 "./src/main/fc/fc_rc.c" 3 4
                                  1
# 241 "./src/main/fc/fc_rc.c"
                                      ;
        }
    } else {
    ...
    if (readyToCalculateRate || isRXDataNew) {
        ...
        isRXDataNew = 
# 265 "./src/main/fc/fc_rc.c" 3 4
                     0
# 265 "./src/main/fc/fc_rc.c"
                          ;
    }
}
...
void updateRcCommands(void)
{
    ...
    if (feature(FEATURE_3D) && isModeActivationConditionPresent(BOX3DONASWITCH) && !failsafeIsActive()) {
        if (IS_RC_MODE_ACTIVE(BOX3DONASWITCH)) {
            reverseMotors = 
# 333 "./src/main/fc/fc_rc.c" 3 4
                           1
# 333 "./src/main/fc/fc_rc.c"
                               ;
            fix12_t throttleScaler = qConstruct(rcCommand[THROTTLE] - 1000, 1000);
            ...
            reverseMotors = 
# 338 "./src/main/fc/fc_rc.c" 3 4
                           0
# 338 "./src/main/fc/fc_rc.c"
                                ;
            fix12_t throttleScaler = qConstruct(rcCommand[THROTTLE] - 1000, 1000);
            rcCommand[THROTTLE] = rxConfig()->midrc + qMultiply(throttleScaler, 2000 - rxConfig()->midrc);
        }
