...
void updateArmingStatus(void)
{
    if ((armingFlags & (ARMED))) {
        ledSet(0, 
# 153 "./src/main/fc/fc_core.c" 3 4
       1
# 153 "./src/main/fc/fc_core.c"
       );
    } else {
        ...
        if (!isUsingSticksForArming()) {
            static 
# 163 "./src/main/fc/fc_core.c" 3 4
                  _Bool 
# 163 "./src/main/fc/fc_core.c"
                       hadRx = 
# 163 "./src/main/fc/fc_core.c" 3 4
                               0
# 163 "./src/main/fc/fc_core.c"
    ...
    if (!isArmingDisabled()) {
        ...
        if (isMotorProtocolDshot() && isModeActivationConditionPresent(BOXFLIPOVERAFTERCRASH)) {
            ...
            if (!IS_RC_MODE_ACTIVE(BOXFLIPOVERAFTERCRASH)) {
                flipOverAfterCrashMode = 
# 269 "./src/main/fc/fc_core.c" 3 4
                                        0
# 269 "./src/main/fc/fc_core.c"
                                             ;
                pwmWriteDshotCommand(255, getMotorCount(), DSHOT_CMD_SPIN_DIRECTION_NORMAL);
            } else {
                flipOverAfterCrashMode = 
# 272 "./src/main/fc/fc_core.c" 3 4
                                        1
# 272 "./src/main/fc/fc_core.c"
                                            ;
...
void handleInflightCalibrationStickPosition(void)
{
    if (AccInflightCalibrationMeasurementDone) {
        ...
        AccInflightCalibrationMeasurementDone = 
# 325 "./src/main/fc/fc_core.c" 3 4
                                               0
# 325 "./src/main/fc/fc_core.c"
                                                    ;
        AccInflightCalibrationSavetoEEProm = 
...
static void updateInflightCalibrationState(void)
{
    if (AccInflightCalibrationArmed && (armingFlags & (ARMED)) && rcData[THROTTLE] > rxConfig()->mincheck && !IS_RC_MODE_ACTIVE(BOXARM)) {
        ...
        AccInflightCalibrationArmed = 
# 341 "./src/main/fc/fc_core.c" 3 4
                                     0
# 341 "./src/main/fc/fc_core.c"
                                          ;
    }
    if (IS_RC_MODE_ACTIVE(BOXCALIB)) {
        if (!AccInflightCalibrationActive && !AccInflightCalibrationMeasurementDone)
            InflightcalibratingA = 50;
        AccInflightCalibrationActive = 
# 346 "./src/main/fc/fc_core.c" 3 4
                                      1
# 346 "./src/main/fc/fc_core.c"
                                          ;
...
# 376 "./src/main/fc/fc_core.c"
    ...
    if (isAirmodeActive() && (armingFlags & (ARMED))) {
        if (rcData[THROTTLE] >= rxConfig()->airModeActivateThreshold) airmodeIsActivated = 
# 396 "./src/main/fc/fc_core.c" 3 4
                                                                                          1
# 396 "./src/main/fc/fc_core.c"
                                                                                              ;
    } else {
        airmodeIsActivated = 
        ...
        if (isUsingSticksForArming()) {
            if (throttleStatus == THROTTLE_LOW) {
                if (armingConfig()->auto_disarm_delay != 0
                    ...
                    disarm();
                    armedBeeperOn = 
# 429 "./src/main/fc/fc_core.c" 3 4
                                   0
# 429 "./src/main/fc/fc_core.c"
                                        ;
                } else {
...
# 433 "./src/main/fc/fc_core.c"
                ...
                if (armedBeeperOn) {
                    beeperSilence();
                    armedBeeperOn = 
# 444 "./src/main/fc/fc_core.c" 3 4
                                   0
# 444 "./src/main/fc/fc_core.c"
                                        ;
                }
            }
        } else {
            ...
            if (throttleStatus == THROTTLE_LOW) {
                beeper(BEEPER_ARMED);
                armedBeeperOn = 
# 451 "./src/main/fc/fc_core.c" 3 4
                               1
# 451 "./src/main/fc/fc_core.c"
                                   ;
            } else if (armedBeeperOn) {
                beeperSilence();
                armedBeeperOn = 
# 454 "./src/main/fc/fc_core.c" 3 4
                               0
# 454 "./src/main/fc/fc_core.c"
                                    ;
            }
        }
    }
...
# 483 "./src/main/fc/fc_core.c"
    ...
    if ((flightModeFlags & (ANGLE_MODE)) || (flightModeFlags & (HORIZON_MODE))) {
        ledSet(1, 
# 504 "./src/main/fc/fc_core.c" 3 4
       1
# 504 "./src/main/fc/fc_core.c"
       );
    } else {
        ledSet(1, 
...
# 732 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 732 "./src/main/fc/fc_core.c"
    isFlipOverAfterCrashMode(void)
{
