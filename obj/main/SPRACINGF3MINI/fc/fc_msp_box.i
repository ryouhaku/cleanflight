...
const box_t *findBoxByBoxId(boxId_e boxId)
{
    ...
    return 
# 97 "./src/main/fc/fc_msp_box.c" 3 4
          ((void *)0)
# 97 "./src/main/fc/fc_msp_box.c"
              ;
}
           ...
           activeBoxIdGet(boxId_e boxId)
{
    if (boxId > sizeof(activeBoxIds) * 8)
        return 
# 113 "./src/main/fc/fc_msp_box.c" 3 4
              0
# 113 "./src/main/fc/fc_msp_box.c"
                   ;
...
# 262 "./src/main/fc/fc_msp_box.c" 3 4
                                       ((void *)0)
# 262 "./src/main/fc/fc_msp_box.c"
                                           )
...
int packFlightModeFlags(boxBitmask_t *mspFlightModeFlags)
{
    ...
    const uint64_t rcModeCopyMask = (1ULL << (BOXHEADADJ)) | (1ULL << (BOXCAMSTAB)) | (1ULL << (BOXCAMTRIG)) | (1ULL << (BOXBEEPERON))
        ...
        | (1ULL << (BOXANTIGRAVITY)) | (1ULL << (BOXFPVANGLEMIX)) | (1ULL << (BOXFLIPOVERAFTERCRASH)) | (1ULL << (BOX3DDISABLE)) | (1ULL << (BOXBEEPGPSCOUNT));
