...
void init(void)
{
    ...
    if (strncasecmp(systemConfig()->boardIdentifier, "SRFM", sizeof("SRFM"))) {
        resetEEPROM();
    }
...
# 310 "./src/main/fc/fc_init.c" 3 4
       _Bool 
# 310 "./src/main/fc/fc_init.c"
            bothButtonsHeld;
        do {
...
# 488 "./src/main/fc/fc_init.c"
    ...
    ledSet(1, 
# 522 "./src/main/fc/fc_init.c" 3 4
   1
# 522 "./src/main/fc/fc_init.c"
   );
    ledSet(0, 
# 523 "./src/main/fc/fc_init.c" 3 4
   0
# 523 "./src/main/fc/fc_init.c"
   );
    ledSet(2, 
...
# 530 "./src/main/fc/fc_init.c"
        ...
        delay(25);
        systemBeep(
# 532 "./src/main/fc/fc_init.c" 3 4
       0
# 532 "./src/main/fc/fc_init.c"
       );
    }
    ledSet(0, 
# 534 "./src/main/fc/fc_init.c" 3 4
   0
# 534 "./src/main/fc/fc_init.c"
   );
    ledSet(1, 
...
# 558 "./src/main/fc/fc_init.c" 3 4
                                   ((void *)0)
# 558 "./src/main/fc/fc_init.c"
                                       ;
# 587 "./src/main/fc/fc_init.c"
    if (!osdDisplayPort)
...
# 660 "./src/main/fc/fc_init.c" 3 4
                        0
# 660 "./src/main/fc/fc_init.c"
                             );
    ...
    vtxTrampInit();
# 691 "./src/main/fc/fc_init.c"
    timerStart();

    (stateFlags |= (SMALL_ANGLE));
# 704 "./src/main/fc/fc_init.c"
    batteryInit();
