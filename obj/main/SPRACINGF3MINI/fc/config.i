...
# 101 "./src/main/fc/config.c" 2


pidProfile_t *currentPidProfile;
# 116 "./src/main/fc/config.c"
...
# 142 "./src/main/fc/config.c" 3 4
1
# 142 "./src/main/fc/config.c"
, .boardIdentifier = "SRFM" }
...
extern const sdcardConfig_t pgResetTemplate_sdcardConfig; sdcardConfig_t sdcardConfig_System; sdcardConfig_t sdcardConfig_Copy; extern const pgRegistry_t sdcardConfig_Registry; const pgRegistry_t sdcardConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 511 | (0 << 12), .size = sizeof(sdcardConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&sdcardConfig_System, .copy = (uint8_t*)&sdcardConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_sdcardConfig}, };

const sdcardConfig_t pgResetTemplate_sdcardConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .useDma = 
# 187 "./src/main/fc/config.c" 3 4
0 
# 187 "./src/main/fc/config.c"
}
...
# 199 "./src/main/fc/config.c" 3 4
                             1
# 199 "./src/main/fc/config.c"
                                 ;
    adcConfig->vbat.ioTag = ((ioTag_t)((((0) + 1) << 4) | (4)));
# 209 "./src/main/fc/config.c"
    adcConfig->current.enabled = 
# 209 "./src/main/fc/config.c" 3 4
                                1
# 209 "./src/main/fc/config.c"
                                    ;
...
# 214 "./src/main/fc/config.c" 3 4
                             1
# 214 "./src/main/fc/config.c"
                                 ;
...
void pgResetFn_pwmConfig(pwmConfig_t *pwmConfig)
{
    ...
    int inputIndex = 0;
    for (int i = 0; i < 12 && inputIndex < 8; i++) {
...
# 336 "./src/main/fc/config.c" 3 4
                                                                      ((void *)0)
# 336 "./src/main/fc/config.c"
                                                                          )
...
# 404 "./src/main/fc/config.c"
        featureClear(FEATURE_SOFTSERIAL);
    }
# 425 "./src/main/fc/config.c"
    if (!isSerialConfigValid(serialConfig())) {
        pgResetFn_serialConfig(serialConfigMutable());
    }
# 445 "./src/main/fc/config.c"
    featureClear(FEATURE_GPS);



    featureClear(FEATURE_SONAR);
# 473 "./src/main/fc/config.c"
    featureClear(FEATURE_OSD);
# 485 "./src/main/fc/config.c"
...
# 519 "./src/main/fc/config.c" 3 4
                                             0
# 519 "./src/main/fc/config.c"
                                                  ;
    }
