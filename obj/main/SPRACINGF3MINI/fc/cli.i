...
# 65 "./src/main/fc/runtime_config.h" 3 4
_Bool 
# 65 "./src/main/fc/runtime_config.h"
...
# 96 "./src/main/fc/runtime_config.h"
typedef enum {
    GPS_FIX_HOME = (1 << 0),
    GPS_FIX = (1 << 1),
    CALIBRATE_MAG = (1 << 2),
...
# 113 "./src/main/fc/runtime_config.h" 3 4
_Bool 
# 113 "./src/main/fc/runtime_config.h"
...
# 136 "./src/main/fc/cli.c" 2


static serialPort_t *cliPort;
# 148 "./src/main/fc/cli.c"
...
# 167 "./src/main/fc/cli.c" 3 4
                                                                   ((void *)0)

# 168 "./src/main/fc/cli.c"
};
...
# 178 "./src/main/fc/cli.c" 3 4
                                                                                ((void *)0)

# 179 "./src/main/fc/cli.c"
};
...
# 192 "./src/main/fc/cli.c" 3 4
                                                            ((void *)0)

# 193 "./src/main/fc/cli.c"
};
...
static 
# 259 "./src/main/fc/cli.c" 3 4
      _Bool 
# 259 "./src/main/fc/cli.c"
...
# 263 "./src/main/fc/cli.c" 3 4
       __builtin_va_start(
# 263 "./src/main/fc/cli.c"
       va
# 263 "./src/main/fc/cli.c" 3 4
       ,
# 263 "./src/main/fc/cli.c"
...
# 265 "./src/main/fc/cli.c" 3 4
       __builtin_va_end(
# 265 "./src/main/fc/cli.c"
       va
# 265 "./src/main/fc/cli.c" 3 4
       )
# 265 "./src/main/fc/cli.c"
                 ;
        return 
# 266 "./src/main/fc/cli.c" 3 4
              1
# 266 "./src/main/fc/cli.c"
                  ;
    } else {
        return 
# 268 "./src/main/fc/cli.c" 3 4
              0
# 268 "./src/main/fc/cli.c"
                   ;
    }
}
...
static 
# 277 "./src/main/fc/cli.c" 3 4
      _Bool 
# 277 "./src/main/fc/cli.c"
...
# 283 "./src/main/fc/cli.c" 3 4
       __builtin_va_start(
# 283 "./src/main/fc/cli.c"
       va
# 283 "./src/main/fc/cli.c" 3 4
       ,
# 283 "./src/main/fc/cli.c"
...
# 285 "./src/main/fc/cli.c" 3 4
       __builtin_va_end(
# 285 "./src/main/fc/cli.c"
       va
# 285 "./src/main/fc/cli.c" 3 4
       )
# 285 "./src/main/fc/cli.c"
                 ;
        return 
# 286 "./src/main/fc/cli.c" 3 4
              1
# 286 "./src/main/fc/cli.c"
                  ;
    } else {
        return 
# 288 "./src/main/fc/cli.c" 3 4
              0
# 288 "./src/main/fc/cli.c"
                   ;
    }
}
...
# 297 "./src/main/fc/cli.c" 3 4
   __builtin_va_end(
# 297 "./src/main/fc/cli.c"
   va
# 297 "./src/main/fc/cli.c" 3 4
   )
# 297 "./src/main/fc/cli.c"
...
# 304 "./src/main/fc/cli.c" 3 4
   __builtin_va_start(
# 304 "./src/main/fc/cli.c"
   va
# 304 "./src/main/fc/cli.c" 3 4
   ,
# 304 "./src/main/fc/cli.c"
...
# 306 "./src/main/fc/cli.c" 3 4
   __builtin_va_end(
# 306 "./src/main/fc/cli.c"
   va
# 306 "./src/main/fc/cli.c" 3 4
   )
# 306 "./src/main/fc/cli.c"
...
# 310 "./src/main/fc/cli.c" 3 4
                                                                              _Bool 
# 310 "./src/main/fc/cli.c"
                                                                                   full)
{
...
static 
# 373 "./src/main/fc/cli.c" 3 4
      _Bool 
# 373 "./src/main/fc/cli.c"
           valuePtrEqualsDefault(uint8_t type, const void *ptr, const void *ptrDefault)
{
    
# 375 "./src/main/fc/cli.c" 3 4
   _Bool 
# 375 "./src/main/fc/cli.c"
        result = 
# 375 "./src/main/fc/cli.c" 3 4
                 0
# 375 "./src/main/fc/cli.c"
...
static void dumpPgValue(const clivalue_t *value, uint8_t dumpMask)
{
    ...
    const 
# 432 "./src/main/fc/cli.c" 3 4
         _Bool 
# 432 "./src/main/fc/cli.c"
...
# 437 "./src/main/fc/cli.c" 3 4
                                                                         0
# 437 "./src/main/fc/cli.c"
                                                                              );
            cliPrintLinefeed();
        }
        cliPrintf(format, value->name);
        printValuePointer(value, pg->copy + valueOffset, 
# 441 "./src/main/fc/cli.c" 3 4
                                                        0
# 441 "./src/main/fc/cli.c"
                                                             );
        cliPrintLinefeed();
    }
}
...
# 457 "./src/main/fc/cli.c" 3 4
                                              _Bool 
# 457 "./src/main/fc/cli.c"
                                                   full)
{
...
static 
# 567 "./src/main/fc/cli.c" 3 4
      _Bool 
# 567 "./src/main/fc/cli.c"
           isEmpty(const char *string)
{
    return (string == 
# 569 "./src/main/fc/cli.c" 3 4
                     ((void *)0) 
# 569 "./src/main/fc/cli.c"
                          || *string == '\0') ? 
# 569 "./src/main/fc/cli.c" 3 4
                                                1 
# 569 "./src/main/fc/cli.c"
...
# 578 "./src/main/fc/cli.c"
        ...
        const 
# 580 "./src/main/fc/cli.c" 3 4
             _Bool 
# 580 "./src/main/fc/cli.c"
...
# 626 "./src/main/fc/cli.c" 3 4
           _Bool 
# 626 "./src/main/fc/cli.c"
                requireValue = channelFailsafeConfig->mode == RX_FAILSAFE_MODE_SET;
...
# 732 "./src/main/fc/cli.c" 3 4
                                                          ((void *)0)
# 732 "./src/main/fc/cli.c"
                                                              );
    } else {
        ptr = cmdline;
        i = atoi(ptr++);
...
# 774 "./src/main/fc/cli.c" 3 4
       _Bool 
# 774 "./src/main/fc/cli.c"
            equalsDefault = 
# 774 "./src/main/fc/cli.c" 3 4
                            0
# 774 "./src/main/fc/cli.c"
...
# 805 "./src/main/fc/cli.c" 3 4
                                                ((void *)0)
# 805 "./src/main/fc/cli.c"
                                                    );
        return;
    }
...
static void cliSerialPassthrough(char *cmdline)
{
    ...
    while (tok != 
# 897 "./src/main/fc/cli.c" 3 4
                 ((void *)0)
# 897 "./src/main/fc/cli.c"
                     ) {
        switch (index) {
        case 0:
            id = atoi(tok);
        ...
        index++;
        tok = strtok_r(
# 913 "./src/main/fc/cli.c" 3 4
                      ((void *)0)
# 913 "./src/main/fc/cli.c"
                          , " ", &saveptr);
    }
...
# 919 "./src/main/fc/cli.c" 3 4
                                                                    ((void *)0)
# 919 "./src/main/fc/cli.c"
                                                                        ) {
        if (!baud) {
...
# 927 "./src/main/fc/cli.c" 3 4
                                                           ((void *)0)
# 927 "./src/main/fc/cli.c"
                                                               ,
                                         baud, mode,
                                         SERIAL_NOT_INVERTED);
        if (!passThroughPort) {
...
# 954 "./src/main/fc/cli.c" 3 4
                                               ((void *)0)
# 954 "./src/main/fc/cli.c"
                                                   , 
# 954 "./src/main/fc/cli.c" 3 4
                                                     ((void *)0)
# 954 "./src/main/fc/cli.c"
...
# 964 "./src/main/fc/cli.c" 3 4
       _Bool 
# 964 "./src/main/fc/cli.c"
            equalsDefault = 
# 964 "./src/main/fc/cli.c" 3 4
                            0
# 964 "./src/main/fc/cli.c"
...
# 1001 "./src/main/fc/cli.c" 3 4
                                                              ((void *)0)
# 1001 "./src/main/fc/cli.c"
                                                                  );
    } else {
        ptr = cmdline;
        i = atoi(ptr++);
...
# 1070 "./src/main/fc/cli.c" 3 4
       _Bool 
# 1070 "./src/main/fc/cli.c"
            equalsDefault = 
# 1070 "./src/main/fc/cli.c" 3 4
                            0
# 1070 "./src/main/fc/cli.c"
        ...
        if (defaultCustomMotorMixer) {
            ...
            const 
# 1076 "./src/main/fc/cli.c" 3 4
                 _Bool 
# 1076 "./src/main/fc/cli.c"
...
# 1105 "./src/main/fc/cli.c" 3 4
                                                       ((void *)0)
# 1105 "./src/main/fc/cli.c"
                                                           );
        ...
        if (ptr) {
            ...
            for (uint32_t i = 0; ; i++) {
                if (mixerNames[i] == 
# 1116 "./src/main/fc/cli.c" 3 4
                                    ((void *)0)
# 1116 "./src/main/fc/cli.c"
                                        ) {
        ...
        if (i < 8) {
            ...
            if (check != 4) {
                ...
                printMotorMix(DUMP_MASTER, customMotorMixer(0), 
# 1155 "./src/main/fc/cli.c" 3 4
                                                               ((void *)0)
# 1155 "./src/main/fc/cli.c"
                                                                   );
            }
        } else {
...
# 1168 "./src/main/fc/cli.c" 3 4
       _Bool 
# 1168 "./src/main/fc/cli.c"
            equalsDefault = 
# 1168 "./src/main/fc/cli.c" 3 4
                            0
# 1168 "./src/main/fc/cli.c"
...
# 1192 "./src/main/fc/cli.c" 3 4
                                                           ((void *)0)
# 1192 "./src/main/fc/cli.c"
                                                               );
...
# 1237 "./src/main/fc/cli.c" 3 4
       _Bool 
# 1237 "./src/main/fc/cli.c"
            equalsDefault = 
# 1237 "./src/main/fc/cli.c" 3 4
                            0
# 1237 "./src/main/fc/cli.c"
...
# 1254 "./src/main/fc/cli.c" 3 4
                                                           ((void *)0)
# 1254 "./src/main/fc/cli.c"
                                                               );
    } else {
        ptr = cmdline;
        i = atoi(ptr);
...
# 1274 "./src/main/fc/cli.c" 3 4
       _Bool 
# 1274 "./src/main/fc/cli.c"
            equalsDefault = 
# 1274 "./src/main/fc/cli.c" 3 4
                            0
# 1274 "./src/main/fc/cli.c"
...
# 1289 "./src/main/fc/cli.c" 3 4
                                                         ((void *)0)
# 1289 "./src/main/fc/cli.c"
                                                             );
    } else {
        const char *ptr = cmdline;
...
# 1310 "./src/main/fc/cli.c" 3 4
           _Bool 
# 1310 "./src/main/fc/cli.c"
                equalsDefault = 
# 1310 "./src/main/fc/cli.c" 3 4
                                0
# 1310 "./src/main/fc/cli.c"
...
# 1322 "./src/main/fc/cli.c" 3 4
       _Bool 
# 1322 "./src/main/fc/cli.c"
            equalsDefault = 
# 1322 "./src/main/fc/cli.c" 3 4
                            0
# 1322 "./src/main/fc/cli.c"
...
# 1332 "./src/main/fc/cli.c" 3 4
   _Bool 
# 1332 "./src/main/fc/cli.c"
        equalsDefault = 
# 1332 "./src/main/fc/cli.c" 3 4
                        0
# 1332 "./src/main/fc/cli.c"
...
# 1344 "./src/main/fc/cli.c" 3 4
                                                     ((void *)0)
# 1344 "./src/main/fc/cli.c"
                                                         );
    } else {
        ...
        while (ptr && argNo < ARGS_COUNT) {
            args[argNo++] = atoi(ptr);
            ptr = strtok_r(
# 1353 "./src/main/fc/cli.c" 3 4
                          ((void *)0)
# 1353 "./src/main/fc/cli.c"
                              , " ", &saveptr);
        }

        if (ptr != 
# 1356 "./src/main/fc/cli.c" 3 4
                  ((void *)0) 
# 1356 "./src/main/fc/cli.c"
                       || argNo != ARGS_COUNT) {
            cliShowParseError();
            return;
        }
...
# 1381 "./src/main/fc/cli.c" 3 4
       _Bool 
# 1381 "./src/main/fc/cli.c"
            equalsDefault = 
# 1381 "./src/main/fc/cli.c" 3 4
                            0
# 1381 "./src/main/fc/cli.c"
...
# 1413 "./src/main/fc/cli.c" 3 4
           _Bool 
# 1413 "./src/main/fc/cli.c"
...
# 1426 "./src/main/fc/cli.c" 3 4
                                               1
# 1426 "./src/main/fc/cli.c"
                                                   , format, i , channel);
                }
            }
        }
...
# 1444 "./src/main/fc/cli.c" 3 4
                                               ((void *)0)
# 1444 "./src/main/fc/cli.c"
                                                   );
    } else {
...
# 1516 "./src/main/fc/cli.c" 3 4
       _Bool 
# 1516 "./src/main/fc/cli.c"
            equalsDefault = 
# 1516 "./src/main/fc/cli.c" 3 4
                            0
# 1516 "./src/main/fc/cli.c"
...
# 1559 "./src/main/fc/cli.c" 3 4
                                                        ((void *)0)
# 1559 "./src/main/fc/cli.c"
                                                            );
    } else if (strncasecmp(cmdline, "reset", 5) == 0) {
        ...
        if (ptr) {
            ...
            for (uint32_t i = 0; ; i++) {
                if (mixerNames[i] == 
# 1571 "./src/main/fc/cli.c" 3 4
                                    ((void *)0)
# 1571 "./src/main/fc/cli.c"
                                        ) {
                    cliPrintLine("Invalid name");
                    break;
                }
        ...
        while (ptr != 
# 1605 "./src/main/fc/cli.c" 3 4
                     ((void *)0) 
# 1605 "./src/main/fc/cli.c"
                          && check < ARGS_COUNT - 1) {
            args[check++] = atoi(ptr);
            ptr = strtok_r(
# 1607 "./src/main/fc/cli.c" 3 4
                          ((void *)0)
# 1607 "./src/main/fc/cli.c"
                              , " ", &saveptr);
        }

        if (ptr == 
# 1610 "./src/main/fc/cli.c" 3 4
                  ((void *)0) 
# 1610 "./src/main/fc/cli.c"
                       || check != ARGS_COUNT - 1) {
            cliShowParseError();
            return;
        }
        ...
        while (ptr != 
# 1630 "./src/main/fc/cli.c" 3 4
                     ((void *)0) 
# 1630 "./src/main/fc/cli.c"
                          && check < ARGS_COUNT) {
            args[check++] = atoi(ptr);
            ptr = strtok_r(
# 1632 "./src/main/fc/cli.c" 3 4
                          ((void *)0)
# 1632 "./src/main/fc/cli.c"
                              , " ", &saveptr);
        }

        if (ptr != 
# 1635 "./src/main/fc/cli.c" 3 4
                  ((void *)0) 
# 1635 "./src/main/fc/cli.c"
                       || check != ARGS_COUNT) {
            cliShowParseError();
            return;
        }
...
# 1645 "./src/main/fc/cli.c" 3 4
                                              (0xff) 
# 1645 "./src/main/fc/cli.c"
                                                              &&
...
# 1839 "./src/main/fc/cli.c" 3 4
   _Bool 
# 1839 "./src/main/fc/cli.c"
        equalsDefault = 
# 1839 "./src/main/fc/cli.c" 3 4
                        0
# 1839 "./src/main/fc/cli.c"
...
# 1875 "./src/main/fc/cli.c" 3 4
                                          ((void *)0)
# 1875 "./src/main/fc/cli.c"
                                              );
    } else {
        ptr = cmdline;
        i = atoi(ptr++);
...
{
    const 
# 1923 "./src/main/fc/cli.c" 3 4
         _Bool 
# 1923 "./src/main/fc/cli.c"
...
static void cliFeature(char *cmdline)
{
    ...
    if (len == 0) {
        ...
        for (uint32_t i = 0; ; i++) {
            if (featureNames[i] == 
# 1971 "./src/main/fc/cli.c" 3 4
                                  ((void *)0)
# 1971 "./src/main/fc/cli.c"
                                      )
                break;
            if (mask & (1 << i))
        ...
        for (uint32_t i = 0; ; i++) {
            if (featureNames[i] == 
# 1980 "./src/main/fc/cli.c" 3 4
                                  ((void *)0)
# 1980 "./src/main/fc/cli.c"
                                      )
                break;
            if (strcmp(featureNames[i], emptryString) != 0)
                cliPrintf(" %s", featureNames[i]);
...
# 1988 "./src/main/fc/cli.c" 3 4
       _Bool 
# 1988 "./src/main/fc/cli.c"
            remove = 
# 1988 "./src/main/fc/cli.c" 3 4
                     0
# 1988 "./src/main/fc/cli.c"
        ...
        if (cmdline[0] == '-') {
            ...
            remove = 
# 1991 "./src/main/fc/cli.c" 3 4
                    1
# 1991 "./src/main/fc/cli.c"
                        ;
            cmdline++;
            len--;
        }
        ...
        for (uint32_t i = 0; ; i++) {
            if (featureNames[i] == 
# 1997 "./src/main/fc/cli.c" 3 4
                                  ((void *)0)
# 1997 "./src/main/fc/cli.c"
                                      ) {
                cliPrintLine("Invalid name");
                break;
            }
...
# 2072 "./src/main/fc/cli.c" 3 4
       _Bool 
# 2072 "./src/main/fc/cli.c"
            remove = 
# 2072 "./src/main/fc/cli.c" 3 4
                     0
# 2072 "./src/main/fc/cli.c"
        ...
        if (cmdline[0] == '-') {
            remove = 
# 2074 "./src/main/fc/cli.c" 3 4
                    1
# 2074 "./src/main/fc/cli.c"
                        ;
            cmdline++;
            len--;
        }
...
# 2122 "./src/main/fc/cli.c"
static void printMap(uint8_t dumpMask, const rxConfig_t *rxConfig, const rxConfig_t *defaultRxConfig)
{
    
# 2124 "./src/main/fc/cli.c" 3 4
   _Bool 
# 2124 "./src/main/fc/cli.c"
        equalsDefault = 
# 2124 "./src/main/fc/cli.c" 3 4
                        1
# 2124 "./src/main/fc/cli.c"
...
static void cliMap(char *cmdline)
{
    ...
    if (len == 8) {
        ...
        for (i = 0; i < 8; i++) {
            buf[i] = 
# 2152 "./src/main/fc/cli.c" 3
                    __extension__ ({ __typeof__ (
# 2152 "./src/main/fc/cli.c"
...
# 2152 "./src/main/fc/cli.c"
        ...
        for (i = 0; i < 8; i++) {
            buf[i] = 
# 2157 "./src/main/fc/cli.c" 3
                    __extension__ ({ __typeof__ (
# 2157 "./src/main/fc/cli.c"
                    (unsigned char)cmdline[i]
# 2157 "./src/main/fc/cli.c" 3
                    ) __x = (
# 2157 "./src/main/fc/cli.c"
...
static char *checkCommand(char *cmdLine, const char *command)
{
    if (!strncasecmp(cmdLine, command, strlen(command))
        && (
# 2182 "./src/main/fc/cli.c" 3
           ((((__locale_ctype_ptr ())+sizeof(""[
# 2182 "./src/main/fc/cli.c"
           (unsigned)cmdLine[strlen(command)]
# 2182 "./src/main/fc/cli.c" 3
           ]))[(int)(
# 2182 "./src/main/fc/cli.c"
           (unsigned)cmdLine[strlen(command)]
...
# 2189 "./src/main/fc/cli.c" 3 4
                       _Bool 
# 2189 "./src/main/fc/cli.c"
                            bootLoader)
{
    cliPrint("\r\nRebooting");
    bufWriterFlush(cliWriter);
...
{
    cliRebootEx(
# 2204 "./src/main/fc/cli.c" 3 4
               0
# 2204 "./src/main/fc/cli.c"
                    );
}
...
static void cliBootloader(char *cmdLine)
{
    ...
    ;
    cliRebootEx(
# 2212 "./src/main/fc/cli.c" 3 4
               1
# 2212 "./src/main/fc/cli.c"
                   );
}
...
static void cliExit(char *cmdline)
{
    ...
    *cliBuffer = '\0';
    ...
    cliWriter = 
# 2229 "./src/main/fc/cli.c" 3 4
               ((void *)0)
# 2229 "./src/main/fc/cli.c"
                   ;
}
# 2241 "./src/main/fc/cli.c"
static int parseOutputIndex(char *pch, 
# 2241 "./src/main/fc/cli.c" 3 4
                                      _Bool 
# 2241 "./src/main/fc/cli.c"
                                           allowAllEscs) {
...
# 2272 "./src/main/fc/cli.c" 3 4
   _Bool 
# 2272 "./src/main/fc/cli.c"
        escInfoReceived = 
# 2272 "./src/main/fc/cli.c" 3 4
                          0
# 2272 "./src/main/fc/cli.c"
    ...
    if (bytesRead > 12) {
        ...
        if (bytesRead == frameLength) {
            escInfoReceived = 
# 2288 "./src/main/fc/cli.c" 3 4
                             1
# 2288 "./src/main/fc/cli.c"
                                 ;
...
# 2455 "./src/main/fc/cli.c" 3 4
   _Bool 
# 2455 "./src/main/fc/cli.c"
        firstCommand = 
# 2455 "./src/main/fc/cli.c" 3 4
                       1
# 2455 "./src/main/fc/cli.c"
                           ;
    while (pch != 
# 2456 "./src/main/fc/cli.c" 3 4
                 ((void *)0)
# 2456 "./src/main/fc/cli.c"
                     ) {
        switch (pos) {
        case 0:
            escIndex = parseOutputIndex(pch, 
# 2459 "./src/main/fc/cli.c" 3 4
                                            1
# 2459 "./src/main/fc/cli.c"
                                                );
            if (escIndex == -1) {
                return;
            }
        ...
        default:
            {
                ...
                if (command >= 0 && command < 48) {
                    if (firstCommand) {
                        ...
                        firstCommand = 
# 2478 "./src/main/fc/cli.c" 3 4
                                      0
# 2478 "./src/main/fc/cli.c"
                                           ;
                    }
        ...
        pos++;
        pch = strtok_r(
# 2507 "./src/main/fc/cli.c" 3 4
                      ((void *)0)
# 2507 "./src/main/fc/cli.c"
                          , " ", &saveptr);
    }
...
static void cliEscPassthrough(char *cmdline)
{
    ...
    int escIndex = 0;
    while (pch != 
# 2528 "./src/main/fc/cli.c" 3 4
                 ((void *)0)
# 2528 "./src/main/fc/cli.c"
                     ) {
        switch (pos) {
        case 0:
        ...
        pos++;
        pch = strtok_r(
# 2561 "./src/main/fc/cli.c" 3 4
                      ((void *)0)
# 2561 "./src/main/fc/cli.c"
                          , " ", &saveptr);
    }
...
static void cliMixer(char *cmdline)
{
    ...
    if (len == 0) {
        ...
        for (uint32_t i = 0; ; i++) {
            if (mixerNames[i] == 
# 2581 "./src/main/fc/cli.c" 3 4
                                ((void *)0)
# 2581 "./src/main/fc/cli.c"
                                    )
                break;
    ...
    for (uint32_t i = 0; ; i++) {
        if (mixerNames[i] == 
# 2590 "./src/main/fc/cli.c" 3 4
                            ((void *)0)
# 2590 "./src/main/fc/cli.c"
                                ) {
            cliPrintLine("Invalid name");
            return;
        }
...
static void cliMotor(char *cmdline)
{
    ...
    int index = 0;
    while (pch != 
# 2618 "./src/main/fc/cli.c" 3 4
                 ((void *)0)
# 2618 "./src/main/fc/cli.c"
                     ) {
        switch (index) {
        case 0:
            motorIndex = parseOutputIndex(pch, 
# 2621 "./src/main/fc/cli.c" 3 4
                                              1
# 2621 "./src/main/fc/cli.c"
                                                  );
            if (motorIndex == -1) {
                return;
            }
        ...
        index++;
        pch = strtok_r(
# 2633 "./src/main/fc/cli.c" 3 4
                      ((void *)0)
# 2633 "./src/main/fc/cli.c"
                          , " ", &saveptr);
    }
...
# 2759 "./src/main/fc/cli.c" 3 4
   _Bool 
# 2759 "./src/main/fc/cli.c"
        saveConfigs;

    if (isEmpty(cmdline)) {
        saveConfigs = 
# 2762 "./src/main/fc/cli.c" 3 4
                     1
# 2762 "./src/main/fc/cli.c"
                         ;
...
# 2764 "./src/main/fc/cli.c"
    ...
    if (saveConfigs) {
        cliSave(
# 2772 "./src/main/fc/cli.c" 3 4
               ((void *)0)
# 2772 "./src/main/fc/cli.c"
                   );
    }
}
...
# 2834 "./src/main/fc/cli.c" 3 4
                                                ((void *)0)
# 2834 "./src/main/fc/cli.c"
                                                    ) {
...
# 2849 "./src/main/fc/cli.c" 3 4
               _Bool 
# 2849 "./src/main/fc/cli.c"
                    valueChanged = 
# 2849 "./src/main/fc/cli.c" 3 4
                                   0
# 2849 "./src/main/fc/cli.c"
                ...
                case MODE_DIRECT: {
                        ...
                        if (value >= val->config.minmax.min && value <= val->config.minmax.max) {
                            cliSetVar(val, value);
                            valueChanged = 
# 2857 "./src/main/fc/cli.c" 3 4
                                          1
# 2857 "./src/main/fc/cli.c"
                                              ;
                        }
                    }
...
# 2864 "./src/main/fc/cli.c" 3 4
                       _Bool 
# 2864 "./src/main/fc/cli.c"
                            matched = 
# 2864 "./src/main/fc/cli.c" 3 4
                                      0
# 2864 "./src/main/fc/cli.c"
                        ...
                        for (uint32_t tableValueIndex = 0; tableValueIndex < tableEntry->valueCount && !matched; tableValueIndex++) {
                            ...
                            if (matched) {
                                ...
                                cliSetVar(val, value);
                                valueChanged = 
# 2872 "./src/main/fc/cli.c" 3 4
                                              1
# 2872 "./src/main/fc/cli.c"
                                                  ;
                            }
                        }
                    }
                ...
                case MODE_ARRAY: {
                        ...
                        for (int i = 0; i < arrayLength; i++) {
                            ...
                            if ((valEndPtr != 
# 2889 "./src/main/fc/cli.c" 3 4
                                             ((void *)0)
# 2889 "./src/main/fc/cli.c"
                                                 ) || (i == arrayLength - 1)){
                                ...
                                valueChanged = 
# 2928 "./src/main/fc/cli.c" 3 4
                                              1
# 2928 "./src/main/fc/cli.c"
                                                  ;
...
# 2968 "./src/main/fc/cli.c" 3 4
                                 ((void *)0)
# 2968 "./src/main/fc/cli.c"
                                     ) {
            break;
        }
    ...
    cliSdInfo(
# 2985 "./src/main/fc/cli.c" 3 4
             ((void *)0)
# 2985 "./src/main/fc/cli.c"
                 );
...
const cliResourceValue_t resourceTable[] = {
    ...
    { OWNER_BEEPER, 503, 
# 3114 "./src/main/fc/cli.c" 3 4
                                                __builtin_offsetof (
# 3114 "./src/main/fc/cli.c"
                                                beeperDevConfig_t
# 3114 "./src/main/fc/cli.c" 3 4
                                                , 
# 3114 "./src/main/fc/cli.c"
...
# 3114 "./src/main/fc/cli.c"
    ...
    { OWNER_MOTOR, 6, 
# 3116 "./src/main/fc/cli.c" 3 4
                                           __builtin_offsetof (
# 3116 "./src/main/fc/cli.c"
                                           motorConfig_t
# 3116 "./src/main/fc/cli.c" 3 4
                                           , 
# 3116 "./src/main/fc/cli.c"
...
# 3116 "./src/main/fc/cli.c"
    ...
    { OWNER_SERVO, 52, 
# 3118 "./src/main/fc/cli.c" 3 4
                                           __builtin_offsetof (
# 3118 "./src/main/fc/cli.c"
                                           servoConfig_t
# 3118 "./src/main/fc/cli.c" 3 4
                                           , 
# 3118 "./src/main/fc/cli.c"
...
# 3118 "./src/main/fc/cli.c"
    ...
    { OWNER_PPMINPUT, 507, 
# 3121 "./src/main/fc/cli.c" 3 4
                                         __builtin_offsetof (
# 3121 "./src/main/fc/cli.c"
                                         ppmConfig_t
# 3121 "./src/main/fc/cli.c" 3 4
                                         , 
# 3121 "./src/main/fc/cli.c"
...
# 3121 "./src/main/fc/cli.c"
                                                                     , 0 },
    { OWNER_PWMINPUT, 508, 
# 3122 "./src/main/fc/cli.c" 3 4
                                         __builtin_offsetof (
# 3122 "./src/main/fc/cli.c"
                                         pwmConfig_t
# 3122 "./src/main/fc/cli.c" 3 4
                                         , 
# 3122 "./src/main/fc/cli.c"
...
# 3122 "./src/main/fc/cli.c"
    ...
    { OWNER_LED_STRIP, 27, 
# 3129 "./src/main/fc/cli.c" 3 4
                                               __builtin_offsetof (
# 3129 "./src/main/fc/cli.c"
                                               ledStripConfig_t
# 3129 "./src/main/fc/cli.c" 3 4
                                               , 
# 3129 "./src/main/fc/cli.c"
...
# 3129 "./src/main/fc/cli.c"
    ...
    { OWNER_SERIAL_TX, 509, 
# 3131 "./src/main/fc/cli.c" 3 4
                                                __builtin_offsetof (
# 3131 "./src/main/fc/cli.c"
                                                serialPinConfig_t
# 3131 "./src/main/fc/cli.c" 3 4
                                                , 
# 3131 "./src/main/fc/cli.c"
...
# 3131 "./src/main/fc/cli.c"
                                                                                       , (10 + 2) },
    { OWNER_SERIAL_RX, 509, 
# 3132 "./src/main/fc/cli.c" 3 4
                                                __builtin_offsetof (
# 3132 "./src/main/fc/cli.c"
                                                serialPinConfig_t
# 3132 "./src/main/fc/cli.c" 3 4
                                                , 
# 3132 "./src/main/fc/cli.c"
...
# 3132 "./src/main/fc/cli.c"
    ...
    { OWNER_I2C_SCL, 518, 
# 3137 "./src/main/fc/cli.c" 3 4
                                         __builtin_offsetof (
# 3137 "./src/main/fc/cli.c"
                                         i2cConfig_t
# 3137 "./src/main/fc/cli.c" 3 4
                                         , 
# 3137 "./src/main/fc/cli.c"
...
# 3137 "./src/main/fc/cli.c"
                                                                           , 2 },
    { OWNER_I2C_SDA, 518, 
# 3138 "./src/main/fc/cli.c" 3 4
                                         __builtin_offsetof (
# 3138 "./src/main/fc/cli.c"
                                         i2cConfig_t
# 3138 "./src/main/fc/cli.c" 3 4
                                         , 
# 3138 "./src/main/fc/cli.c"
...
# 3138 "./src/main/fc/cli.c"
    ...
    { OWNER_LED, 505, 
# 3140 "./src/main/fc/cli.c" 3 4
                                                __builtin_offsetof (
# 3140 "./src/main/fc/cli.c"
                                                statusLedConfig_t
# 3140 "./src/main/fc/cli.c" 3 4
                                                , 
# 3140 "./src/main/fc/cli.c"
...
# 3140 "./src/main/fc/cli.c"
    ...
    { OWNER_RX_BIND, 24, 
# 3142 "./src/main/fc/cli.c" 3 4
                                        __builtin_offsetof (
# 3142 "./src/main/fc/cli.c"
                                        rxConfig_t
# 3142 "./src/main/fc/cli.c" 3 4
                                        , 
# 3142 "./src/main/fc/cli.c"
...
# 3143 "./src/main/fc/cli.c" 3 4
                                        __builtin_offsetof (
# 3143 "./src/main/fc/cli.c"
                                        rxConfig_t
# 3143 "./src/main/fc/cli.c" 3 4
                                        , 
# 3143 "./src/main/fc/cli.c"
...
# 3146 "./src/main/fc/cli.c" 3 4
                                                 __builtin_offsetof (
# 3146 "./src/main/fc/cli.c"
                                                 transponderConfig_t
# 3146 "./src/main/fc/cli.c" 3 4
                                                 , 
# 3146 "./src/main/fc/cli.c"
...
# 3146 "./src/main/fc/cli.c"
    ...
    { OWNER_SPI_SCK, 520, 
# 3149 "./src/main/fc/cli.c" 3 4
                                             __builtin_offsetof (
# 3149 "./src/main/fc/cli.c"
                                             spiPinConfig_t
# 3149 "./src/main/fc/cli.c" 3 4
                                             , 
# 3149 "./src/main/fc/cli.c"
...
# 3149 "./src/main/fc/cli.c"
                                                                                  , 3 },
    { OWNER_SPI_MISO, 520, 
# 3150 "./src/main/fc/cli.c" 3 4
                                             __builtin_offsetof (
# 3150 "./src/main/fc/cli.c"
                                             spiPinConfig_t
# 3150 "./src/main/fc/cli.c" 3 4
                                             , 
# 3150 "./src/main/fc/cli.c"
...
# 3150 "./src/main/fc/cli.c"
                                                                                   , 3 },
    { OWNER_SPI_MOSI, 520, 
# 3151 "./src/main/fc/cli.c" 3 4
                                             __builtin_offsetof (
# 3151 "./src/main/fc/cli.c"
                                             spiPinConfig_t
# 3151 "./src/main/fc/cli.c" 3 4
                                             , 
# 3151 "./src/main/fc/cli.c"
...
# 3151 "./src/main/fc/cli.c"
    ...
    { OWNER_ESCSERIAL, 521, 
# 3154 "./src/main/fc/cli.c" 3 4
                                               __builtin_offsetof (
# 3154 "./src/main/fc/cli.c"
                                               escSerialConfig_t
# 3154 "./src/main/fc/cli.c" 3 4
                                               , 
# 3154 "./src/main/fc/cli.c"
...
# 3157 "./src/main/fc/cli.c" 3 4
                                                     __builtin_offsetof (
# 3157 "./src/main/fc/cli.c"
                                                     cameraControlConfig_t
# 3157 "./src/main/fc/cli.c" 3 4
                                                     , 
# 3157 "./src/main/fc/cli.c"
...
# 3157 "./src/main/fc/cli.c"
    ...
    { OWNER_ADC_BATT, 510, 
# 3160 "./src/main/fc/cli.c" 3 4
                                         __builtin_offsetof (
# 3160 "./src/main/fc/cli.c"
                                         adcConfig_t
# 3160 "./src/main/fc/cli.c" 3 4
                                         , 
# 3160 "./src/main/fc/cli.c"
...
# 3160 "./src/main/fc/cli.c"
                                                                          , 0 },
    { OWNER_ADC_RSSI, 510, 
# 3161 "./src/main/fc/cli.c" 3 4
                                         __builtin_offsetof (
# 3161 "./src/main/fc/cli.c"
                                         adcConfig_t
# 3161 "./src/main/fc/cli.c" 3 4
                                         , 
# 3161 "./src/main/fc/cli.c"
...
# 3161 "./src/main/fc/cli.c"
                                                                          , 0 },
    { OWNER_ADC_CURR, 510, 
# 3162 "./src/main/fc/cli.c" 3 4
                                         __builtin_offsetof (
# 3162 "./src/main/fc/cli.c"
                                         adcConfig_t
# 3162 "./src/main/fc/cli.c" 3 4
                                         , 
# 3162 "./src/main/fc/cli.c"
...
# 3162 "./src/main/fc/cli.c"
                                                                             , 0 },
    { OWNER_ADC_EXT, 510, 
# 3163 "./src/main/fc/cli.c" 3 4
                                         __builtin_offsetof (
# 3163 "./src/main/fc/cli.c"
                                         adcConfig_t
# 3163 "./src/main/fc/cli.c" 3 4
                                         , 
# 3163 "./src/main/fc/cli.c"
...
# 3163 "./src/main/fc/cli.c"
    ...
    { OWNER_BARO_CS, 38, 
# 3166 "./src/main/fc/cli.c" 3 4
                                               __builtin_offsetof (
# 3166 "./src/main/fc/cli.c"
                                               barometerConfig_t
# 3166 "./src/main/fc/cli.c" 3 4
                                               , 
# 3166 "./src/main/fc/cli.c"
...
# 3166 "./src/main/fc/cli.c"
    ...
    { OWNER_COMPASS_CS, 40, 
# 3169 "./src/main/fc/cli.c" 3 4
                                             __builtin_offsetof (
# 3169 "./src/main/fc/cli.c"
                                             compassConfig_t
# 3169 "./src/main/fc/cli.c" 3 4
                                             , 
# 3169 "./src/main/fc/cli.c"
...
static void printResource(uint8_t dumpMask)
{
    for (unsigned int i = 0; i < (sizeof(resourceTable) / sizeof((resourceTable)[0])); i++) {
        ...
        if (configIsInCopy) {
            ...
            defaultConfig = 
# 3191 "./src/main/fc/cli.c" 3 4
                           ((void *)0)
# 3191 "./src/main/fc/cli.c"
                               ;
        }
...
# 3198 "./src/main/fc/cli.c" 3 4
           _Bool 
# 3198 "./src/main/fc/cli.c"
...
# 3237 "./src/main/fc/cli.c" 3 4
               _Bool 
# 3237 "./src/main/fc/cli.c"
                    cleared = 
# 3237 "./src/main/fc/cli.c" 3 4
                              0
# 3237 "./src/main/fc/cli.c"
                ...
                if (r == resourceIndex) {
                    ...
                    *tag = 0;
                    cleared = 
# 3243 "./src/main/fc/cli.c" 3 4
                             1
# 3243 "./src/main/fc/cli.c"
                                 ;
                }
...
static void cliResource(char *cmdline)
{
    ...
    if (len == 0) {
        ...
        for (int i = 0; i < DMA_MAX_DESCRIPTORS; i++) {
            ...
            cliPrintf("DMA%d Channel %d:", i / 7 + 1, (i % 7) + 1);
    ...
    int index = 0;
    char *pch = 
# 3318 "./src/main/fc/cli.c" 3 4
               ((void *)0)
# 3318 "./src/main/fc/cli.c"
                   ;
    char *saveptr;
    ...
    pch = strtok_r(
# 3333 "./src/main/fc/cli.c" 3 4
                  ((void *)0)
# 3333 "./src/main/fc/cli.c"
                      , " ", &saveptr);
    index = atoi(pch);
    ...
    if (resourceTable[resourceIndex].maxIndex > 0 || index > 0) {
        ...
        pch = strtok_r(
# 3343 "./src/main/fc/cli.c" 3 4
                      ((void *)0)
# 3343 "./src/main/fc/cli.c"
                          , " ", &saveptr);
    }
        ...
        if (strcasecmp(pch, "NONE") == 0) {
            *tag = 0;
            ...
            if (port < 8) {
                ...
                pin = atoi(pch);
                if (pin < 16) {
                    ioRec_t *rec = IO_Rec(IOGetByTag(((ioTag_t)((((port) + 1) << 4) | (pin)))));
                    if (rec) {
                        resourceCheck(resourceIndex, index, ((ioTag_t)((((port) + 1) << 4) | (pin))));
...
static void backupConfigs(void)
{
    ...
    configIsInCopy = 
# 3397 "./src/main/fc/cli.c" 3 4
                    1
# 3397 "./src/main/fc/cli.c"
                        ;
}
...
static void restoreConfigs(void)
{
    ...
    configIsInCopy = 
# 3406 "./src/main/fc/cli.c" 3 4
                    0
# 3406 "./src/main/fc/cli.c"
                         ;
}

static void printConfig(char *cmdline, 
# 3409 "./src/main/fc/cli.c" 3 4
                                      _Bool 
# 3409 "./src/main/fc/cli.c"
                                           doDiff)
{
    ...
    if ((dumpMask & DUMP_MASTER) || (dumpMask & DUMP_ALL)) {
        ;
        cliVersion(
# 3442 "./src/main/fc/cli.c" 3 4
                  ((void *)0)
# 3442 "./src/main/fc/cli.c"
                      );
        ...
        ;
        const 
# 3460 "./src/main/fc/cli.c" 3 4
             _Bool 
# 3460 "./src/main/fc/cli.c"
...
{
    printConfig(cmdline, 
# 3564 "./src/main/fc/cli.c" 3 4
                        0
# 3564 "./src/main/fc/cli.c"
                             );
}
...
{
    printConfig(cmdline, 
# 3569 "./src/main/fc/cli.c" 3 4
                        1
# 3569 "./src/main/fc/cli.c"
                            );
}
...
# 3723 "./src/main/fc/cli.c" 3 4
                                          ((void *)0)
# 3723 "./src/main/fc/cli.c"
                                              , *pend = 
# 3723 "./src/main/fc/cli.c" 3 4
                                                        ((void *)0)
# 3723 "./src/main/fc/cli.c"
            ...
            p = strchr(p, '#');
            if (
# 3771 "./src/main/fc/cli.c" 3 4
               ((void *)0) 
# 3771 "./src/main/fc/cli.c"
                    != p) {
