...
static 
# 71 "./src/main/rx/spektrum.c" 3 4
      _Bool 
# 71 "./src/main/rx/spektrum.c"
           spektrumSatInternal = 
# 71 "./src/main/rx/spektrum.c" 3 4
                                 1
# 71 "./src/main/rx/spektrum.c"
...
# 179 "./src/main/rx/spektrum.c"
            ...
            rcFrameComplete = 
# 181 "./src/main/rx/spektrum.c" 3 4
                             1
...

    {
      ...
      if (spektrumSatInternal) {
        ...
        if ( !( (system == 0x01) |
                ...
                (system == 0xb2) ) ){
          spektrumSatInternal =
# 257 "./src/main/rx/spektrum.c" 3 4
                              0
# 257 "./src/main/rx/spektrum.c"
                                   ;
        }
      }
...
# 321 "./src/main/rx/spektrum.c" 3 4
_Bool 
# 321 "./src/main/rx/spektrum.c"
...
# 395 "./src/main/rx/spektrum.c"
    ...
    IOWrite(bindIO, 
# 398 "./src/main/rx/spektrum.c" 3 4
                   1
# 398 "./src/main/rx/spektrum.c"
                       );


    delay(60);
    ledSet(1, 
# 402 "./src/main/rx/spektrum.c" 3 4
   0
# 402 "./src/main/rx/spektrum.c"
   );

    for (int i = 0; i < rxConfig->spektrum_sat_bind; i++) {
        ledSet(0, 
# 405 "./src/main/rx/spektrum.c" 3 4
       0
# 405 "./src/main/rx/spektrum.c"
       );
        ledSet(2, 
...
# 406 "./src/main/rx/spektrum.c"
        ...
        IOWrite(bindIO, 
# 408 "./src/main/rx/spektrum.c" 3 4
                       0
# 408 "./src/main/rx/spektrum.c"
                            );
        delayMicroseconds(120);

        ledSet(0, 
# 411 "./src/main/rx/spektrum.c" 3 4
       1
# 411 "./src/main/rx/spektrum.c"
       );
        ledSet(2, 
# 412 "./src/main/rx/spektrum.c" 3 4
       1
# 412 "./src/main/rx/spektrum.c"
       );

        IOWrite(bindIO, 
# 414 "./src/main/rx/spektrum.c" 3 4
                       1
# 414 "./src/main/rx/spektrum.c"
                           );
        delayMicroseconds(120);
...
# 440 "./src/main/rx/spektrum.c" 3 4
_Bool 
# 440 "./src/main/rx/spektrum.c"
    spektrumInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    if (!portConfig) {
        return 
# 446 "./src/main/rx/spektrum.c" 3 4
              0
# 446 "./src/main/rx/spektrum.c"
                   ;
    }

    srxlEnabled = 
# 449 "./src/main/rx/spektrum.c" 3 4
                 0
# 449 "./src/main/rx/spektrum.c"
                      ;

    
# 451 "./src/main/rx/spektrum.c" 3 4
   _Bool 
# 451 "./src/main/rx/spektrum.c"
    ...
    case SERIALRX_SPEKTRUM2048:
        ...
        spek_chan_mask = 0x07;
        spekHiRes = 
# 465 "./src/main/rx/spektrum.c" 3 4
                   1
# 465 "./src/main/rx/spektrum.c"
                       ;
        resolution = 2048;
    ...
    case SERIALRX_SPEKTRUM1024:
        ...
        spek_chan_mask = 0x03;
        spekHiRes = 
# 474 "./src/main/rx/spektrum.c" 3 4
                   0
# 474 "./src/main/rx/spektrum.c"
                        ;
        resolution = 1024;
    ...
    return serialPort != 
# 506 "./src/main/rx/spektrum.c" 3 4
                        ((void *)0)
# 506 "./src/main/rx/spektrum.c"
                            ;
}
...
# 526 "./src/main/rx/spektrum.c" 3 4
_Bool 
# 526 "./src/main/rx/spektrum.c"
    srxlRxIsActive(void)
{
    return serialPort != 
# 528 "./src/main/rx/spektrum.c" 3 4
                        ((void *)0)
# 528 "./src/main/rx/spektrum.c"
                            ;
}
