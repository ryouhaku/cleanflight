...
{
    *(rxConfig) = (rxConfig_t) { .halfDuplex = 0, .serialrx_provider = 0, .rx_spi_protocol = 0, .serialrx_inverted = 0, .spektrum_sat_bind = 0, .spektrum_sat_bind_autoreset = 1, .midrc = 1500, .mincheck = 1050, .maxcheck = 1900, .rx_min_usec = 885, .rx_max_usec = 2115, .rssi_channel = 0, .rssi_scale = (4095.0f / 100.0f + 0.5f), .rssi_invert = 0, .rcInterpolation = RC_SMOOTHING_AUTO, .rcInterpolationChannels = 0, .rcInterpolationInterval = 19, .fpvCamAngleDegrees = 0, .max_aux_channel = (18 - 4), .airModeActivateThreshold = 1350, .spektrum_bind_pin_override_ioTag = 0, .spektrum_bind_plug_ioTag = ((ioTag_t)((((1) + 1) << 4) | (0))), };
# 147 "./src/main/rx/rx.c"
     ;
...
# 219 "./src/main/rx/rx.c" 3 4
                                                                    _Bool 
# 219 "./src/main/rx/rx.c"
                                                                         valid)
{
    if (channel < 4 && !valid) {
...
# 228 "./src/main/rx/rx.c" 3 4
_Bool 
# 228 "./src/main/rx/rx.c"
...
void rxInit(void)
{
    ...
    if (feature(FEATURE_RX_SERIAL)) {
        const 
# 321 "./src/main/rx/rx.c" 3 4
             _Bool 
# 321 "./src/main/rx/rx.c"
...
# 357 "./src/main/rx/rx.c" 3 4
_Bool 
# 357 "./src/main/rx/rx.c"
    rxIsReceivingSignal(void)
{
...
# 362 "./src/main/rx/rx.c" 3 4
_Bool 
# 362 "./src/main/rx/rx.c"
    rxAreFlightChannelsValid(void)
{
...
# 392 "./src/main/rx/rx.c"
                                   ;
            rxSignalReceivedNotDataDriven = 
# 393 "./src/main/rx/rx.c" 3 4
                                           0
# 393 "./src/main/rx/rx.c"
                                                ;
        }
    }
...
# 400 "./src/main/rx/rx.c"
                                               ;
            rxIsInFailsafeModeNotDataDriven = 
# 401 "./src/main/rx/rx.c" 3 4
                                             0
# 401 "./src/main/rx/rx.c"
                                                  ;
...
# 407 "./src/main/rx/rx.c"
                                               ;
            rxIsInFailsafeModeNotDataDriven = 
# 408 "./src/main/rx/rx.c" 3 4
                                             0
# 408 "./src/main/rx/rx.c"
                                                  ;
            needRxSignalBefore = currentTimeUs + needRxSignalMaxDelayUs;
        }
    } else
...
static uint16_t calculateChannelMovingAverage(uint8_t chan, uint16_t sample)
{
    ...
    static 
# 430 "./src/main/rx/rx.c" 3 4
          _Bool 
# 430 "./src/main/rx/rx.c"
               rxSamplesCollected = 
# 430 "./src/main/rx/rx.c" 3 4
                                    0
# 430 "./src/main/rx/rx.c"
    ...
    if (!rxSamplesCollected) {
        ...
        rxSamplesCollected = 
# 442 "./src/main/rx/rx.c" 3 4
                            1
# 442 "./src/main/rx/rx.c"
                                ;
    }
...
# 514 "./src/main/rx/rx.c"
                             ;
    const 
# 515 "./src/main/rx/rx.c" 3 4
         _Bool 
# 515 "./src/main/rx/rx.c"
    ...
    if (!rxSignalReceived || rxIsInFailsafeMode) {
        useValueFromRx = 
# 524 "./src/main/rx/rx.c" 3 4
                        0
# 524 "./src/main/rx/rx.c"
                             ;
    }
...
# 539 "./src/main/rx/rx.c"
    ...
    if ((rxFlightChannelsValid) && !IS_RC_MODE_ACTIVE(BOXFAILSAFE)) {
        ...
        rxIsInFailsafeMode = rxIsInFailsafeModeNotDataDriven = 
# 565 "./src/main/rx/rx.c" 3 4
                                                              1
# 565 "./src/main/rx/rx.c"
                                                                  ;
