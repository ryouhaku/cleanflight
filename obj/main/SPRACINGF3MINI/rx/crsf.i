...
# 56 "./src/main/rx/crsf.c"
static 
# 56 "./src/main/rx/crsf.c" 3 4
                  _Bool 
# 56 "./src/main/rx/crsf.c"
                       crsfFrameDone = 
# 56 "./src/main/rx/crsf.c" 3 4
...
static uint8_t crsfFrameStatus(void)
{
    if (crsfFrameDone) {
        crsfFrameDone = 
# 181 "./src/main/rx/crsf.c" 3 4
                       0
# 181 "./src/main/rx/crsf.c"
                            ;
        if (crsfFrame.frame.type == CRSF_FRAMETYPE_RC_CHANNELS_PACKED) {
...
# 242 "./src/main/rx/crsf.c" 3 4
_Bool 
# 242 "./src/main/rx/crsf.c"
    crsfRxInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    if (!portConfig) {
        return 
# 256 "./src/main/rx/crsf.c" 3 4
              0
# 256 "./src/main/rx/crsf.c"
                   ;
    }
    ...
    return serialPort != 
# 267 "./src/main/rx/crsf.c" 3 4
                        ((void *)0)
# 267 "./src/main/rx/crsf.c"
                            ;
}
...
{
    return serialPort != 
# 272 "./src/main/rx/crsf.c" 3 4
                        ((void *)0)
# 272 "./src/main/rx/crsf.c"
                            ;
}
